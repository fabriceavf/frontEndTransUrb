...
import './PostespointeusesCard.dart';
import './CreatePostespointeuses.dart';
import './UpdatePostespointeuses.dart';

class PostespointeusesScreen extends StatelessWidget {
int? id = 0;
PostespointeusesScreen({Key? key}) {
try {
...
final PostespointeusesState c = Get.put(PostespointeusesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdatePostespointeusesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreatePostespointeusesScreen(),barrierDismissible: false);},
table:'postespointeuses',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['poste_id'].toString())),DataCell(Text(data['pointeuse_id'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['creat_by'].toString())),],
    ),),],),
),
...
class PostespointeusesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="postespointeuses".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/postespointeuses-Aggrid'.obs;
var table= 'postespointeuses'.obs;
