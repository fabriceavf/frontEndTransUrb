...
class CreateDependancesScreen extends StatelessWidget {
int? id = 0;

CreateDependancesScreen({Key? key }){
    try {
...
final CreateDependancesState state = Get.put(CreateDependancesState());
...
body:
    ...
    child: Text('Creer un Dependances',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateDependancesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('dependances').add(data);
