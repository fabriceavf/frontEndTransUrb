...
class CreateTachespointeusesScreen extends StatelessWidget {
int? id = 0;

CreateTachespointeusesScreen({Key? key }){
    try {
...
final CreateTachespointeusesState state = Get.put(CreateTachespointeusesState());
...
body:
    ...
    child: Text('Creer un Tachespointeuses',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateTachespointeusesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('tachespointeuses').add(data);
