...
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['transactions_totals'].toString())),DataCell(Text(data['transactions_heures'].toString())),DataCell(Text(data['transactions_id'].toString())),DataCell(Text(data['matricule'].toString())),DataCell(Text(data['date'].toString())),],
    ),),],),
),
