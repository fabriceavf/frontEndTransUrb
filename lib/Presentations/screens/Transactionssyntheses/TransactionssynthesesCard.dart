...
class TransactionssynthesesCardScreen extends StatelessWidget {
int? id = 0;
Map data;
        TransactionssynthesesCardScreen({Key? key,required this.data}) {
            try {
            ...
            final TransactionssynthesesCardState state = Get.put(TransactionssynthesesCardState());
        return BlocsWidget(
        child:Column(children: <Widget>[
            ...
            children: <Widget>[
                ...
                class TransactionssynthesesCardState extends GetxController {
                var errors= [].obs;
                ...
                var data=getForm();
                DioInstance.post('/api/transactionssyntheses', data).then((response) {
