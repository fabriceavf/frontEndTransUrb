...
import './ProgrammationsrondesCard.dart';
import './CreateProgrammationsrondes.dart';
import './UpdateProgrammationsrondes.dart';

class ProgrammationsrondesScreen extends StatelessWidget {
int? id = 0;
ProgrammationsrondesScreen({Key? key}) {
try {
...
final ProgrammationsrondesState c = Get.put(ProgrammationsrondesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateProgrammationsrondesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['deleted_at'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateProgrammationsrondesScreen(),barrierDismissible: false);},
table:'programmationsrondes',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['libelle'].toString())),DataCell(Text(data['description'].toString())),DataCell(Text(data['date_debut'].toString())),DataCell(Text(data['date_fin'].toString())),DataCell(Text(data['default_heure_debut'].toString())),DataCell(Text(data['default_heure_fin'].toString())),DataCell(Text(data['user_id'].toString())),DataCell(Text(data['statut'].toString())),DataCell(Text(data['type'].toString())),DataCell(Text(data['postesbaladeur'].toString())),DataCell(Text(data['valider1'].toString())),DataCell(Text(data['zone_id'].toString())),DataCell(Text(data['valider2'].toString())),DataCell(Text(data['poste_id'].toString())),DataCell(Text(data['etats'].toString())),DataCell(Text(data['postes'].toString())),DataCell(Text(data['min_pointage'].toString())),DataCell(Text(data['Allclients'].toString())),DataCell(Text(data['AllDatesInRange'].toString())),DataCell(Text(data['Presents'].toString())),DataCell(Text(data['Abscents'].toString())),DataCell(Text(data['Presentsid'].toString())),DataCell(Text(data['Abscentsid'].toString())),DataCell(Text(data['user_id_2'].toString())),DataCell(Text(data['user_id_3'].toString())),DataCell(Text(data['user_id_4'].toString())),DataCell(Text(data['valideur_1'].toString())),DataCell(Text(data['valideur_2'].toString())),DataCell(Text(data['creat_by'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['deleted_at'].toString())),],
    ),),],),
),
...
class ProgrammationsrondesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="programmationsrondes".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/programmationsrondes-Aggrid'.obs;
var table= 'programmationsrondes'.obs;
        var postesData=[].obs;
        var usersData=[].obs;
        var zonesData=[].obs;
var requette= 3.obs;
