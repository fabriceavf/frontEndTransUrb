...
class CreateProgrammationsrondesScreen extends StatelessWidget {
int? id = 0;

CreateProgrammationsrondesScreen({Key? key }){
    try {
...
final CreateProgrammationsrondesState state = Get.put(CreateProgrammationsrondesState());
...
body:
    ...
    child: Text('Creer un Programmationsrondes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateProgrammationsrondesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('programmationsrondes').add(data);
