...
class UpdateDeploiementspointeusesmoyenstransportsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateDeploiementspointeusesmoyenstransportsScreen({Key? key ,required this.data}){
try {
...
final UpdateDeploiementspointeusesmoyenstransportsState state = Get.put(UpdateDeploiementspointeusesmoyenstransportsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Deploiementspointeusesmoyenstransports',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateDeploiementspointeusesmoyenstransportsState extends GetxController {
    var errors= [].obs;
    ...
    await db.table('deploiementspointeusesmoyenstransports').where('id','=',id).update(data);
