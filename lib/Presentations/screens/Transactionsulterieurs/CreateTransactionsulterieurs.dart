...
class CreateTransactionsulterieursScreen extends StatelessWidget {
int? id = 0;

CreateTransactionsulterieursScreen({Key? key }){
    try {
...
final CreateTransactionsulterieursState state = Get.put(CreateTransactionsulterieursState());
...
body:
    ...
    child: Text('Creer un Transactionsulterieurs',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateTransactionsulterieursState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('transactionsulterieurs').add(data);
