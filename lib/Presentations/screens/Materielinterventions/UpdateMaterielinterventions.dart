...
class UpdateMaterielinterventionsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateMaterielinterventionsScreen({Key? key ,required this.data}){
try {
...
final UpdateMaterielinterventionsState state = Get.put(UpdateMaterielinterventionsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Materielinterventions',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateMaterielinterventionsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['intervention_id']?.text=data['intervention_id'].toString();
    ...
    await db.table('materielinterventions').where('id','=',id).update(data);
    var allMaterielinterventions=await db.table('materielinterventions').get();
    print('allMaterielinterventions');
    print(allMaterielinterventions);
