...
class CreateMaterielinterventionsScreen extends StatelessWidget {
int? id = 0;

CreateMaterielinterventionsScreen({Key? key }){
    try {
...
final CreateMaterielinterventionsState state = Get.put(CreateMaterielinterventionsState());
...
body:
    ...
    child: Text('Creer un Materielinterventions',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateMaterielinterventionsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('materielinterventions').add(data);
