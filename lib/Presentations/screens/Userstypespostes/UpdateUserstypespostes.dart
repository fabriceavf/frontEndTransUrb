...
class UpdateUserstypespostesScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateUserstypespostesScreen({Key? key ,required this.data}){
try {
...
final UpdateUserstypespostesState state = Get.put(UpdateUserstypespostesState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Userstypespostes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateUserstypespostesState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['typesposte_id']?.text=data['typesposte_id'].toString();
    ...
    await db.table('userstypespostes').where('id','=',id).update(data);
    var allUserstypespostes=await db.table('userstypespostes').get();
    print('allUserstypespostes');
    print(allUserstypespostes);
