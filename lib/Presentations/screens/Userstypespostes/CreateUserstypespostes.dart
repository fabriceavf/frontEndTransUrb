...
class CreateUserstypespostesScreen extends StatelessWidget {
int? id = 0;

CreateUserstypespostesScreen({Key? key }){
    try {
...
final CreateUserstypespostesState state = Get.put(CreateUserstypespostesState());
...
body:
    ...
    child: Text('Creer un Userstypespostes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateUserstypespostesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('userstypespostes').add(data);
