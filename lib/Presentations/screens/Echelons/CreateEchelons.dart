...
class CreateEchelonsScreen extends StatelessWidget {
int? id = 0;

CreateEchelonsScreen({Key? key }){
    try {
...
final CreateEchelonsState state = Get.put(CreateEchelonsState());
...
body:
    ...
    child: Text('Creer un Echelons',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateEchelonsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('echelons').add(data);
