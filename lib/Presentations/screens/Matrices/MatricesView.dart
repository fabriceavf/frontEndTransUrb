...
import './MatricesCard.dart';
import './CreateMatrices.dart';
import './UpdateMatrices.dart';

class MatricesScreen extends StatelessWidget {
int? id = 0;
MatricesScreen({Key? key}) {
try {
...
final MatricesState c = Get.put(MatricesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateMatricesScreen(data:data),barrierDismissible: false);},
)
),
...
class MatricesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="matrices".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/matrices-Aggrid'.obs;
var table= 'matrices'.obs;
var requette= 0.obs;
