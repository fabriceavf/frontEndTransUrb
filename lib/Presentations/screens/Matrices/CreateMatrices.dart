...
class CreateMatricesScreen extends StatelessWidget {
int? id = 0;

CreateMatricesScreen({Key? key }){
    try {
...
final CreateMatricesState state = Get.put(CreateMatricesState());
...
body:
    ...
    child: Text('Creer un Matrices',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateMatricesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('matrices').add(data);
