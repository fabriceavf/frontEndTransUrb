...
class UpdateEntreprisesScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateEntreprisesScreen({Key? key ,required this.data}){
try {
...
final UpdateEntreprisesState state = Get.put(UpdateEntreprisesState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Entreprises',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateEntreprisesState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['menu']?.text=data['menu'].toString();
            this.inputControllers['host']?.text=data['host'].toString();
            ...
            this.inputControllers['favicon']?.text=data['favicon'].toString();
            ...
            this.inputControllers['db_user']?.text=data['db_user'].toString();
            this.inputControllers['db_pass']?.text=data['db_pass'].toString();
            this.inputControllers['badge_avant']?.text=data['badge_avant'].toString();
            this.inputControllers['badge_arriere']?.text=data['badge_arriere'].toString();
            this.inputControllers['modules']?.text=data['modules'].toString();
        }
    ...
    await db.table('entreprises').where('id','=',id).update(data);
