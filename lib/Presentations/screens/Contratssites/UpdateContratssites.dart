...
class UpdateContratssitesScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateContratssitesScreen({Key? key ,required this.data}){
try {
...
final UpdateContratssitesState state = Get.put(UpdateContratssitesState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Contratssites',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateContratssitesState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['contratsclient_id']?.text=data['contratsclient_id'].toString();
            this.inputControllers['site_id']?.text=data['site_id'].toString();
            this.inputControllers['prestation_id']?.text=data['prestation_id'].toString();
            this.inputControllers['agentsjour']?.text=data['agentsjour'].toString();
            this.inputControllers['agentsnuit']?.text=data['agentsnuit'].toString();
    ...
    await db.table('contratssites').where('id','=',id).update(data);
