...
class UpdateTerminalsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateTerminalsScreen({Key? key ,required this.data}){
try {
...
final UpdateTerminalsState state = Get.put(UpdateTerminalsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Terminals',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateTerminalsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['adresse_mac']?.text=data['adresse_mac'].toString();
            this.inputControllers['etat']?.text=data['etat'].toString();
            this.inputControllers['alimentation']?.text=data['alimentation'].toString();
            this.inputControllers['reseau']?.text=data['reseau'].toString();
            this.inputControllers['voiture_id']?.text=data['voiture_id'].toString();
    ...
    await db.table('terminals').where('id','=',id).update(data);
