...
class UpdatePositionsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdatePositionsScreen({Key? key ,required this.data}){
try {
...
final UpdatePositionsState state = Get.put(UpdatePositionsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Positions',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdatePositionsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['lat']?.text=data['lat'].toString();
            this.inputControllers['lon']?.text=data['lon'].toString();
            this.inputControllers['name']?.text=data['name'].toString();
            this.inputControllers['title']?.text=data['title'].toString();
            this.inputControllers['speed']?.text=data['speed'].toString();
            this.inputControllers['icon_color']?.text=data['icon_color'].toString();
            this.inputControllers['moyenstransportid']?.text=data['moyenstransportid'].toString();
            ...
            this.inputControllers['tracername']?.text=data['tracername'].toString();
            this.inputControllers['traceruniqueid']?.text=data['traceruniqueid'].toString();
            this.inputControllers['sim']?.text=data['sim'].toString();
    ...
    await db.table('positions').where('id','=',id).update(data);
