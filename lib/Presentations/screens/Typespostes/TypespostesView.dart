...
import './TypespostesCard.dart';
import './CreateTypespostes.dart';
import './UpdateTypespostes.dart';

class TypespostesScreen extends StatelessWidget {
int? id = 0;
TypespostesScreen({Key? key}) {
try {
...
final TypespostesState c = Get.put(TypespostesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateTypespostesScreen(data:data),barrierDismissible: false);},
)
),
...
{
'libelle':'maxagent',
'render':(data)=>DataCell(Text(data['maxagent'].toString())),

},
],
    newElementInitCallback: (){Services.ShowModal(CreateTypespostesScreen(),barrierDismissible: false);},
table:'typespostes',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['code'].toString())),DataCell(Text(data['libelle'].toString())),DataCell(Text(data['creat_by'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['canCreate'].toString())),DataCell(Text(data['canUpdate'].toString())),DataCell(Text(data['canDelete'].toString())),DataCell(Text(data['maxagent'].toString())),],
    ),),],),
),
...
class TypespostesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="typespostes".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/typespostes-Aggrid'.obs;
var table= 'typespostes'.obs;
var requette= 0.obs;
