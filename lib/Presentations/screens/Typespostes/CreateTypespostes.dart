...
class CreateTypespostesScreen extends StatelessWidget {
int? id = 0;

CreateTypespostesScreen({Key? key }){
    try {
...
final CreateTypespostesState state = Get.put(CreateTypespostesState());
...
body:
    ...
    child: Text('Creer un Typespostes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateTypespostesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('typespostes').add(data);
