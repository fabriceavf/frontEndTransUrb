...
class CreatePermissionsScreen extends StatelessWidget {
int? id = 0;

CreatePermissionsScreen({Key? key }){
    try {
...
final CreatePermissionsState state = Get.put(CreatePermissionsState());
...
body:
    ...
    child: Text('Creer un Permissions',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreatePermissionsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('permissions').add(data);
