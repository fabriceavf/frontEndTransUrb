...
import './VacationspostesCard.dart';
import './CreateVacationspostes.dart';
import './UpdateVacationspostes.dart';

class VacationspostesScreen extends StatelessWidget {
int? id = 0;
VacationspostesScreen({Key? key}) {
try {
...
final VacationspostesState c = Get.put(VacationspostesState());
return Scaffold(
appBar: AppBar(
backgroundColor: Theme.of(context).colorScheme.inversePrimary,
title: Text(' Vacationspostes '),
),
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateVacationspostesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateVacationspostesScreen(),barrierDismissible: false);},
table:'vacationspostes',
...
class VacationspostesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="vacationspostes".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/vacationspostes-Aggrid'.obs;
var table= 'vacationspostes'.obs;
        var postesData=[].obs;
var requette= 1.obs;
