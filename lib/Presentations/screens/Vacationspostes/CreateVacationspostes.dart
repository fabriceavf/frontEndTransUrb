...
class CreateVacationspostesScreen extends StatelessWidget {
int? id = 0;

CreateVacationspostesScreen({Key? key }){
    try {
...
final CreateVacationspostesState state = Get.put(CreateVacationspostesState());
...
body:
    ...
    child: Text('Creer un Vacationspostes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateVacationspostesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('vacationspostes').add(data);
