...
class CreateVillesScreen extends StatelessWidget {
  int? id = 0;

  CreateVillesScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final CreateVillesState state = Get.put(CreateVillesState());
...
class CreateVillesState extends GetxController {
  var errors = [].obs;
...
// TODO: implement onInit
  ...
  void createLine() async {
    ...
    await db.table('villes').add(data);
