...
class CreateInterventionsScreen extends StatelessWidget {
int? id = 0;

CreateInterventionsScreen({Key? key }){
    try {
...
final CreateInterventionsState state = Get.put(CreateInterventionsState());
...
body:
    ...
    child: Text('Creer un Interventions',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateInterventionsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('interventions').add(data);
