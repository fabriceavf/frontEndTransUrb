...
class UpdateJobsScreen extends StatelessWidget {
  int? id = 0;
  Map data;

  UpdateJobsScreen({Key? key, required this.data}) {
    try {
  ...
  Widget build(BuildContext context) {
    final UpdateJobsState state = Get.put(UpdateJobsState());
    state.setData(data);
...
class UpdateJobsState extends GetxController {
  var errors = [].obs;
  ...
  void setData(data) {
    ...
    this.inputControllers['queue']?.text = data['queue'].toString();
    this.inputControllers['payload']?.text = data['payload'].toString();
    this.inputControllers['attempts']?.text = data['attempts'].toString();
    this.inputControllers['reserved_at']?.text = data['reserved_at'].toString();
    this.inputControllers['available_at']?.text =
        data['available_at'].toString();
  ...
  void UpdateLine() async {
    ...
    await db.table('jobs').where('id', '=', id).update(data);
