...
class CreateDeplacementsScreen extends StatelessWidget {
int? id = 0;

CreateDeplacementsScreen({Key? key }){
    try {
...
final CreateDeplacementsState state = Get.put(CreateDeplacementsState());
...
body:
    ...
    child: Text('Creer un Deplacements',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateDeplacementsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('deplacements').add(data);
