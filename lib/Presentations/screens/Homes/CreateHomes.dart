...
class CreateHomesScreen extends StatelessWidget {
  int? id = 0;

  CreateHomesScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final CreateHomesState state = Get.put(CreateHomesState());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Obx(() => MyInputWidget(
                      controller: state.inputControllers['user'],
                      label: "user",
                      placeHolder: "",
                      valid: 0)),
                  Obx(() => MyInputWidget(
...
class CreateHomesState extends GetxController {
  var errors = [].obs;
...
// TODO: implement onInit
  ...
  void createLine() async {
    ...
    await db.table('homes').add(data);
    var allHomes = await db.table('homes').get();
    print('allHomes');
    print(allHomes);
  }
