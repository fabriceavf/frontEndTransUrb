...
class UpdatePermissionsdetailsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdatePermissionsdetailsScreen({Key? key ,required this.data}){
try {
...
final UpdatePermissionsdetailsState state = Get.put(UpdatePermissionsdetailsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Permissionsdetails',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
            ...
            Obx(()=>MyInputWidget(controller: state.inputControllers['table'],label: "table",placeHolder: "",valid:0)),
    ...
    class UpdatePermissionsdetailsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['table']?.text=data['table'].toString();
    ...
    await db.table('permissionsdetails').where('id','=',id).update(data);
    var allPermissionsdetails=await db.table('permissionsdetails').get();
    print('allPermissionsdetails');
    print(allPermissionsdetails);
    ...
    void resetForm () {
            ...
            this.inputControllers['table']?.text="";
    ...
    Map<String ,dynamic> getForm () {
        return {
                    ...
                    'table' : this.inputControllers['table']?.text,
