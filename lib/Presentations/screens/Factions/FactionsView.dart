...
import './FactionsCard.dart';
import './CreateFactions.dart';
import './UpdateFactions.dart';

class FactionsScreen extends StatelessWidget {
int? id = 0;
FactionsScreen({Key? key}) {
try {
...
final FactionsState c = Get.put(FactionsState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateFactionsScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateFactionsScreen(),barrierDismissible: false);},
table:'factions',
...
class FactionsState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="factions".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/factions-Aggrid'.obs;
var table= 'factions'.obs;
var requette= 0.obs;
