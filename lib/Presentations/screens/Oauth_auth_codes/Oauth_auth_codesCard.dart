...
class Oauth_auth_codesCardScreen extends StatelessWidget {
int? id = 0;
Map data;
    List<dynamic> clientsData=[];
            List<dynamic> usersData=[];
                Oauth_auth_codesCardScreen({Key? key,required this.data}) {
            try {
            ...
            final Oauth_auth_codesCardState state = Get.put(Oauth_auth_codesCardState());
        return BlocsWidget(
        child:Column(children: <Widget>[
            ...
            children: <Widget>[
                ...
                class Oauth_auth_codesCardState extends GetxController {
                var errors= [].obs;
                ...
                var data=getForm();
                DioInstance.post('/api/oauth_auth_codes', data).then((response) {
