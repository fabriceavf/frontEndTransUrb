...
class CreateSoldablesScreen extends StatelessWidget {
int? id = 0;

CreateSoldablesScreen({Key? key }){
    try {
...
final CreateSoldablesState state = Get.put(CreateSoldablesState());
...
body:
    ...
    child: Text('Creer un Soldables',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateSoldablesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('soldables').add(data);
