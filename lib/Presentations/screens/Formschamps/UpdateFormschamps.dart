...
class UpdateFormschampsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateFormschampsScreen({Key? key ,required this.data}){
try {
...
final UpdateFormschampsState state = Get.put(UpdateFormschampsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Formschamps',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateFormschampsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['width']?.text=data['width'].toString();
    ...
    await db.table('formschamps').where('id','=',id).update(data);
