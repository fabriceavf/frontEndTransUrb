...
class CreateHorairestypessitesScreen extends StatelessWidget {
int? id = 0;

CreateHorairestypessitesScreen({Key? key }){
    try {
...
final CreateHorairestypessitesState state = Get.put(CreateHorairestypessitesState());
...
body:
    ...
    child: Text('Creer un Horairestypessites',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateHorairestypessitesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('horairestypessites').add(data);
