...
class ObjectifsCardScreen extends StatelessWidget {
int? id = 0;
Map data;
    List<dynamic> activitesData=[];
            List<dynamic> usersData=[];
                ObjectifsCardScreen({Key? key,required this.data}) {
            try {
            ...
            final ObjectifsCardState state = Get.put(ObjectifsCardState());
        return BlocsWidget(
        child:Column(children: <Widget>[
            ...
            children: <Widget>[
                ...
                class ObjectifsCardState extends GetxController {
                var errors= [].obs;
                ...
                var data=getForm();
                DioInstance.post('/api/objectifs', data).then((response) {
