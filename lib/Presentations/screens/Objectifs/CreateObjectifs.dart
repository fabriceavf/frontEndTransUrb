...
class CreateObjectifsScreen extends StatelessWidget {
int? id = 0;

CreateObjectifsScreen({Key? key }){
    try {
...
final CreateObjectifsState state = Get.put(CreateObjectifsState());
...
body:
    ...
    child: Text('Creer un Objectifs',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateObjectifsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('objectifs').add(data);
