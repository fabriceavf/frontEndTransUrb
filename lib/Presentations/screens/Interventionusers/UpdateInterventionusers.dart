...
class UpdateInterventionusersScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateInterventionusersScreen({Key? key ,required this.data}){
try {
...
final UpdateInterventionusersState state = Get.put(UpdateInterventionusersState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Interventionusers',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateInterventionusersState extends GetxController {
    var errors= [].obs;
    ...
    await db.table('interventionusers').where('id','=',id).update(data);
