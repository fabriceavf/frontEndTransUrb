...
class CreateMaterielprevisionnelsScreen extends StatelessWidget {
int? id = 0;

CreateMaterielprevisionnelsScreen({Key? key }){
    try {
...
final CreateMaterielprevisionnelsState state = Get.put(CreateMaterielprevisionnelsState());
...
body:
    ...
    child: Text('Creer un Materielprevisionnels',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateMaterielprevisionnelsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('materielprevisionnels').add(data);
