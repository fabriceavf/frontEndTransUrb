...
class CreateSupervirzclientshidesScreen extends StatelessWidget {
int? id = 0;

CreateSupervirzclientshidesScreen({Key? key }){
    try {
...
final CreateSupervirzclientshidesState state = Get.put(CreateSupervirzclientshidesState());
...
body:
    ...
    child: Text('Creer un Supervirzclientshides',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateSupervirzclientshidesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('supervirzclientshides').add(data);
