...
class UpdateSupervirzclientshidesScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateSupervirzclientshidesScreen({Key? key ,required this.data}){
try {
...
final UpdateSupervirzclientshidesState state = Get.put(UpdateSupervirzclientshidesState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Supervirzclientshides',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateSupervirzclientshidesState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['supervirzclient_id']?.text=data['supervirzclient_id'].toString();
    ...
    await db.table('supervirzclientshides').where('id','=',id).update(data);
    var allSupervirzclientshides=await db.table('supervirzclientshides').get();
    print('allSupervirzclientshides');
    print(allSupervirzclientshides);
