...
class CreateVoituresScreen extends StatelessWidget {
int? id = 0;

CreateVoituresScreen({Key? key }){
    try {
...
final CreateVoituresState state = Get.put(CreateVoituresState());
...
body:
    ...
    child: Text('Creer un Voitures',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateVoituresState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('voitures').add(data);
