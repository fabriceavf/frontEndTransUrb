...
class CreateAlarmsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final CreateAlarmsState state = Get.put(CreateAlarmsState());
...
class CreateAlarmsState extends GetxController {
  var errors = [].obs;
...
// TODO: implement onInit
  ...
  void createLine() async {
    ...
    await db.table('alarms').add(data);
