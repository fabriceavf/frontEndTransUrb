...
class UpdateTransactionsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateTransactionsScreen({Key? key ,required this.data}){
try {
...
final UpdateTransactionsState state = Get.put(UpdateTransactionsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Transactions',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateTransactionsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['bio_id']?.text=data['bio_id'].toString();
            this.inputControllers['area_alias']?.text=data['area_alias'].toString();
            this.inputControllers['first_name']?.text=data['first_name'].toString();
            this.inputControllers['last_name']?.text=data['last_name'].toString();
            this.inputControllers['card_no']?.text=data['card_no'].toString();
            this.inputControllers['terminal_alias']?.text=data['terminal_alias'].toString();
            this.inputControllers['emp_code']?.text=data['emp_code'].toString();
            this.inputControllers['punch_date']?.text=data['punch_date'].toString();
            this.inputControllers['punch_time']?.text=data['punch_time'].toString();
            ...
            this.inputControllers['actif_id']?.text=data['actif_id'].toString();
            this.inputControllers['nationalite_id']?.text=data['nationalite_id'].toString();
            this.inputControllers['contrat_id']?.text=data['contrat_id'].toString();
            this.inputControllers['direction_id']?.text=data['direction_id'].toString();
            this.inputControllers['categorie_id']?.text=data['categorie_id'].toString();
            this.inputControllers['echelon_id']?.text=data['echelon_id'].toString();
            this.inputControllers['sexe_id']?.text=data['sexe_id'].toString();
            this.inputControllers['matrimoniale_id']?.text=data['matrimoniale_id'].toString();
            ...
            this.inputControllers['situation_id']?.text=data['situation_id'].toString();
            this.inputControllers['balise_id']?.text=data['balise_id'].toString();
            this.inputControllers['fonction_id']?.text=data['fonction_id'].toString();
            this.inputControllers['online_id']?.text=data['online_id'].toString();
            this.inputControllers['faction_id']?.text=data['faction_id'].toString();
            ...
            this.inputControllers['annuler']?.text=data['annuler'].toString();
            this.inputControllers['type']?.text=data['type'].toString();
            this.inputControllers['traiter']?.text=data['traiter'].toString();
            this.inputControllers['pointeusepostes']?.text=data['pointeusepostes'].toString();
            this.inputControllers['verification']?.text=data['verification'].toString();
            this.inputControllers['rechercheetape']?.text=data['rechercheetape'].toString();
            this.inputControllers['tache']?.text=data['tache'].toString();
            this.inputControllers['poste']?.text=data['poste'].toString();
            this.inputControllers['TachesPotentiels']?.text=data['TachesPotentiels'].toString();
            this.inputControllers['PostesPotentiels']?.text=data['PostesPotentiels'].toString();
            this.inputControllers['TotalPostes']?.text=data['TotalPostes'].toString();
            this.inputControllers['TotalPostescouvert']?.text=data['TotalPostescouvert'].toString();
            this.inputControllers['TotalPostesnoncouvert']?.text=data['TotalPostesnoncouvert'].toString();
            this.inputControllers['TotalPostessouscouvert']?.text=data['TotalPostessouscouvert'].toString();
            this.inputControllers['heure']?.text=data['heure'].toString();
            ...
            this.inputControllers['identification_id']?.text=data['identification_id'].toString();
            this.inputControllers['controlleursacce_id']?.text=data['controlleursacce_id'].toString();
        }
    ...
    await db.table('transactions').where('id','=',id).update(data);
