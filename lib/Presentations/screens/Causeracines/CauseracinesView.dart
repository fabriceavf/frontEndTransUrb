...
import './CauseracinesCard.dart';
import './CreateCauseracines.dart';
import './UpdateCauseracines.dart';

class CauseracinesScreen extends StatelessWidget {
int? id = 0;
CauseracinesScreen({Key? key}) {
try {
...
final CauseracinesState c = Get.put(CauseracinesState());
return Scaffold(
appBar: AppBar(
backgroundColor: Theme.of(context).colorScheme.inversePrimary,
title: Text(' Causeracines '),
),
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateCauseracinesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateCauseracinesScreen(),barrierDismissible: false);},
table:'causeracines',
...
class CauseracinesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="causeracines".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/causeracines-Aggrid'.obs;
var table= 'causeracines'.obs;
var requette= 0.obs;
