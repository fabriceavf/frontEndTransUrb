...
class CreateProvincesScreen extends StatelessWidget {
int? id = 0;

CreateProvincesScreen({Key? key }){
    try {
...
final CreateProvincesState state = Get.put(CreateProvincesState());
...
body:
    ...
    child: Text('Creer un Provinces',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateProvincesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('provinces').add(data);
