...
class CreateInterventionimagesScreen extends StatelessWidget {
int? id = 0;

CreateInterventionimagesScreen({Key? key }){
    try {
...
final CreateInterventionimagesState state = Get.put(CreateInterventionimagesState());
...
body:
    ...
    child: Text('Creer un Interventionimages',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateInterventionimagesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('interventionimages').add(data);
