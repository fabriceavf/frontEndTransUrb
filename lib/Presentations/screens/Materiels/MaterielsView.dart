...
import './MaterielsCard.dart';
import './CreateMateriels.dart';
import './UpdateMateriels.dart';

class MaterielsScreen extends StatelessWidget {
int? id = 0;
MaterielsScreen({Key? key}) {
try {
...
final MaterielsState c = Get.put(MaterielsState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateMaterielsScreen(data:data),barrierDismissible: false);},
)
),
...
{
'libelle':'reference',
'render':(data)=>DataCell(Text(data['reference'].toString())),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateMaterielsScreen(),barrierDismissible: false);},
table:'materiels',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['libelle'].toString())),DataCell(Text(data['reference'].toString())),DataCell(Text(data['description'].toString())),DataCell(Text(data['quantite'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['creat_by'].toString())),],
    ),),],),
),
...
class MaterielsState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="materiels".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/materiels-Aggrid'.obs;
var table= 'materiels'.obs;
var requette= 0.obs;
