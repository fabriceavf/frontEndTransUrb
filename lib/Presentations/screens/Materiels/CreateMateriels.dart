...
class CreateMaterielsScreen extends StatelessWidget {
int? id = 0;

CreateMaterielsScreen({Key? key }){
    try {
...
final CreateMaterielsState state = Get.put(CreateMaterielsState());
...
body:
    ...
    child: Text('Creer un Materiels',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateMaterielsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('materiels').add(data);
