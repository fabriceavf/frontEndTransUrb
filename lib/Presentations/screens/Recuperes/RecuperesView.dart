...
import './RecuperesCard.dart';
import './CreateRecuperes.dart';
import './UpdateRecuperes.dart';

class RecuperesScreen extends StatelessWidget {
int? id = 0;
RecuperesScreen({Key? key}) {
try {
...
final RecuperesState c = Get.put(RecuperesState());
return Scaffold(
appBar: AppBar(
backgroundColor: Theme.of(context).colorScheme.inversePrimary,
title: Text(' Recuperes '),
),
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateRecuperesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateRecuperesScreen(),barrierDismissible: false);},
table:'recuperes',
...
class RecuperesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="recuperes".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/recuperes-Aggrid'.obs;
var table= 'recuperes'.obs;
var requette= 0.obs;
