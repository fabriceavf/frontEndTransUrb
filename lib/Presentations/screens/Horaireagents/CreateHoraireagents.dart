...
class CreateHoraireagentsScreen extends StatelessWidget {
int? id = 0;

CreateHoraireagentsScreen({Key? key }){
    try {
...
final CreateHoraireagentsState state = Get.put(CreateHoraireagentsState());
...
body:
    ...
    child: Text('Creer un Horaireagents',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateHoraireagentsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('horaireagents').add(data);
