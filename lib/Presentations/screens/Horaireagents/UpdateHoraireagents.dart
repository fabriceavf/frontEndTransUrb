...
class UpdateHoraireagentsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateHoraireagentsScreen({Key? key ,required this.data}){
try {
...
final UpdateHoraireagentsState state = Get.put(UpdateHoraireagentsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Horaireagents',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
            ...
            Obx(()=>MyInputWidget(controller: state.inputControllers['typesagents'],label: "typesagents",placeHolder: "",valid:0)),
    ...
    class UpdateHoraireagentsState extends GetxController {
    var errors= [].obs;
    var isLoading= false.obs;
        ...
        var inputControllers={
            ...
            'typesagents':TextEditingController(),
        }.obs;
    ...
    void setData(data){
            ...
            this.inputControllers['typesagents']?.text=data['typesagents'].toString();
        }
    ...
    await db.table('horaireagents').where('id','=',id).update(data);
    var allHoraireagents=await db.table('horaireagents').get();
    print('allHoraireagents');
    print(allHoraireagents);
    ...
    void resetForm () {
            ...
            this.inputControllers['typesagents']?.text="";
    ...
    Map<String ,dynamic> getForm () {
        return {
                    ...
                    'typesagents' : this.inputControllers['typesagents']?.text,
                };
