...
class UpdateProgrammesScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateProgrammesScreen({Key? key ,required this.data}){
try {
...
final UpdateProgrammesState state = Get.put(UpdateProgrammesState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Programmes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateProgrammesState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['qualification_horaire']?.text=data['qualification_horaire'].toString();
        }
    ...
    await db.table('programmes').where('id','=',id).update(data);
