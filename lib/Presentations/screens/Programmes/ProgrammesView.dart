...
import './ProgrammesCard.dart';
import './CreateProgrammes.dart';
import './UpdateProgrammes.dart';

class ProgrammesScreen extends StatelessWidget {
int? id = 0;
ProgrammesScreen({Key? key}) {
try {
...
final ProgrammesState c = Get.put(ProgrammesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateProgrammesScreen(data:data),barrierDismissible: false);},
)
),
...
class ProgrammesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="programmes".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/programmes-Aggrid'.obs;
var table= 'programmes'.obs;
