...
class UpdateFonctionsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateFonctionsScreen({Key? key ,required this.data}){
try {
...
final UpdateFonctionsState state = Get.put(UpdateFonctionsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Fonctions',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
            ...
            FieldSelectWidget(
        label: "services",
        detail: "Veuillez selectionner services",
        placeHolder: "",
        baseData: [],
        model: state.formService_id,
        url:'services-Aggrid',
        filterFields:[ ],
    ...
    class UpdateFonctionsState extends GetxController {
    var errors= [].obs;
    var isLoading= false.obs;
        ...
        var inputControllers={
            ...
            'service_id':TextEditingController(),
    ...
    void setData(data){
            ...
            this.inputControllers['service_id']?.text=data['service_id'].toString();
    ...
    await db.table('fonctions').where('id','=',id).update(data);
    var allFonctions=await db.table('fonctions').get();
    print('allFonctions');
    print(allFonctions);
    ...
    void resetForm () {
            ...
            this.inputControllers['service_id']?.text="";
    ...
    Map<String ,dynamic> getForm () {
        return {
                    ...
                    'service_id' : this.inputControllers['service_id']?.text,
