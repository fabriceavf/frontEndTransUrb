...
class CreateControlleursaccesScreen extends StatelessWidget {
int? id = 0;

CreateControlleursaccesScreen({Key? key }){
    try {
...
final CreateControlleursaccesState state = Get.put(CreateControlleursaccesState());
...
body:
    ...
    child: Text('Creer un Controlleursacces',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateControlleursaccesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('controlleursacces').add(data);
