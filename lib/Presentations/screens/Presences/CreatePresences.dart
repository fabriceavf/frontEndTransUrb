...
class CreatePresencesScreen extends StatelessWidget {
int? id = 0;

CreatePresencesScreen({Key? key }){
    try {
...
final CreatePresencesState state = Get.put(CreatePresencesState());
...
body:
    ...
    child: Text('Creer un Presences',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreatePresencesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('presences').add(data);
