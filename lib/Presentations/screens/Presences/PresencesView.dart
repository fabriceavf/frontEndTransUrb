...
import './PresencesCard.dart';
import './CreatePresences.dart';
import './UpdatePresences.dart';

class PresencesScreen extends StatelessWidget {
int? id = 0;
PresencesScreen({Key? key}) {
try {
...
final PresencesState c = Get.put(PresencesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdatePresencesScreen(data:data),barrierDismissible: false);},
)
),
...
class PresencesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="presences".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/presences-Aggrid'.obs;
var table= 'presences'.obs;
        var usersData=[].obs;
var requette= 1.obs;
