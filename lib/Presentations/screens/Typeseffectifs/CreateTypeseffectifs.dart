...
class CreateTypeseffectifsScreen extends StatelessWidget {
int? id = 0;

CreateTypeseffectifsScreen({Key? key }){
    try {
...
final CreateTypeseffectifsState state = Get.put(CreateTypeseffectifsState());
...
body:
    ...
    child: Text('Creer un Typeseffectifs',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateTypeseffectifsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('typeseffectifs').add(data);
