...
class UpdateTypeseffectifsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateTypeseffectifsScreen({Key? key ,required this.data}){
try {
...
final UpdateTypeseffectifsState state = Get.put(UpdateTypeseffectifsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Typeseffectifs',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
            ...
            Obx(()=>MyInputWidget(controller: state.inputControllers['champHide'],label: "champHide",placeHolder: "",valid:0)),
    ...
    class UpdateTypeseffectifsState extends GetxController {
    var errors= [].obs;
    var isLoading= false.obs;
        ...
        var inputControllers={
            ...
            'champHide':TextEditingController(),
        }.obs;
    ...
    void setData(data){
            ...
            this.inputControllers['champHide']?.text=data['champHide'].toString();
        }
    ...
    await db.table('typeseffectifs').where('id','=',id).update(data);
    var allTypeseffectifs=await db.table('typeseffectifs').get();
    print('allTypeseffectifs');
    print(allTypeseffectifs);
    ...
    void resetForm () {
            ...
            this.inputControllers['champHide']?.text="";
    ...
    Map<String ,dynamic> getForm () {
        return {
                    ...
                    'champHide' : this.inputControllers['champHide']?.text,
                };
