...
import './TypeseffectifsCard.dart';
import './CreateTypeseffectifs.dart';
import './UpdateTypeseffectifs.dart';

class TypeseffectifsScreen extends StatelessWidget {
int? id = 0;
TypeseffectifsScreen({Key? key}) {
try {
...
final TypeseffectifsState c = Get.put(TypeseffectifsState());
return Scaffold(
appBar: AppBar(
backgroundColor: Theme.of(context).colorScheme.inversePrimary,
title: Text(' Typeseffectifs '),
),
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateTypeseffectifsScreen(data:data),barrierDismissible: false);},
)
),
...
{
'libelle':'champHide',
'render':(data)=>DataCell(Text(data['champHide'].toString())),

},
],
    newElementInitCallback: (){Services.ShowModal(CreateTypeseffectifsScreen(),barrierDismissible: false);},
table:'typeseffectifs',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['code'].toString())),DataCell(Text(data['libelle'].toString())),DataCell(Text(data['creat_by'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['canCreate'].toString())),DataCell(Text(data['canUpdate'].toString())),DataCell(Text(data['canDelete'].toString())),DataCell(Text(data['champHide'].toString())),],
    ),),],),
),
...
class TypeseffectifsState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="typeseffectifs".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/typeseffectifs-Aggrid'.obs;
var table= 'typeseffectifs'.obs;
var requette= 0.obs;
