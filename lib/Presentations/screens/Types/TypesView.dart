...
import './CreateTypes.dart';
import './UpdateTypes.dart';
...
class TypesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TypesState c = Get.put(TypesState());
    return Scaffold(
      appBar: AppBar(
          ...
          children: [
            AggridScreen(
              ...
              fields: [
                {
                  ...
                  'render': (data) => DataCell(ButtonWidget(
                        ...
                        text: 'Edit',
                        onTapCallBack: () {
                          Services.ShowModal(UpdateTypesScreen(data: data),
              ...
              newElementInitCallback: () {
                Services.ShowModal(CreateTypesScreen(),
                    barrierDismissible: false);
              },
              table: 'types',
...
class TypesState extends GetxController {
  var isLoading = false.obs;
  var gridApi = null.obs;
  var count = 0.obs;
  var formId = "types".obs;
  var formData = {}.obs;
  var formState = "".obs;
  var formWidth = 'lg'.obs;
  var formKey = 0.obs;
  var tableKey = 0.obs;
  var url = 'http://127.0.0.1:8000/api/types-Aggrid'.obs;
  var table = 'types'.obs;
  var requette = 0.obs;
