...
class CreateTypesScreen extends StatelessWidget {
  int? id = 0;

  CreateTypesScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final CreateTypesState state = Get.put(CreateTypesState());
...
class CreateTypesState extends GetxController {
  var errors = [].obs;
