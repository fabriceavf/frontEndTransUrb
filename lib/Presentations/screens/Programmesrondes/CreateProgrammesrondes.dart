...
class CreateProgrammesrondesScreen extends StatelessWidget {
int? id = 0;

CreateProgrammesrondesScreen({Key? key }){
    try {
...
final CreateProgrammesrondesState state = Get.put(CreateProgrammesrondesState());
...
body:
    ...
    child: Text('Creer un Programmesrondes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateProgrammesrondesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('programmesrondes').add(data);
