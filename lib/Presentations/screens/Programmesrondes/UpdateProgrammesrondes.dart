...
class UpdateProgrammesrondesScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateProgrammesrondesScreen({Key? key ,required this.data}){
try {
...
final UpdateProgrammesrondesState state = Get.put(UpdateProgrammesrondesState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Programmesrondes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
        ...
        SizedBox(height: 2),
            FieldSelectWidget(
        label: "programmationsrondes",
        detail: "Veuillez selectionner programmationsrondes",
        placeHolder: "",
        baseData: [],
        model: state.formProgrammationsronde_id,
        url:'programmationsrondes-Aggrid',
        filterFields:[ ],
        renderDataCallBack: (data) => data['Selectlabel'].toString(),
        ),
        SizedBox(height: 2),
    ...
    class UpdateProgrammesrondesState extends GetxController {
    var errors= [].obs;
    var isLoading= false.obs;
            ...
            var formProgrammationsronde_id="".obs;
            var formUser_id="".obs;
        ...
        var inputControllers={
            ...
            'programmationsronde_id':TextEditingController(),
    ...
    void setData(data){
            ...
            this.inputControllers['volume_horaire']?.text=data['volume_horaire'].toString();
            this.inputControllers['hs_base']?.text=data['hs_base'].toString();
            this.inputControllers['hs_hors_faction']?.text=data['hs_hors_faction'].toString();
            this.inputControllers['hs_in_faction']?.text=data['hs_in_faction'].toString();
            this.inputControllers['programmationsuser_id']?.text=data['programmationsuser_id'].toString();
            this.inputControllers['horaire_id']?.text=data['horaire_id'].toString();
            this.inputControllers['etats']?.text=data['etats'].toString();
            this.inputControllers['totalReel']?.text=data['totalReel'].toString();
            this.inputControllers['totalFictif']?.text=data['totalFictif'].toString();
            this.inputControllers['poste_id']?.text=data['poste_id'].toString();
            this.inputControllers['remplacant']?.text=data['remplacant'].toString();
            this.inputControllers['type']?.text=data['type'].toString();
            this.inputControllers['week']?.text=data['week'].toString();
            this.inputControllers['user']?.text=data['user'].toString();
            this.inputControllers['DayStatut']?.text=data['DayStatut'].toString();
            this.inputControllers['Remplacantuser']?.text=data['Remplacantuser'].toString();
            this.inputControllers['PresencesDeclarer']?.text=data['PresencesDeclarer'].toString();
            this.inputControllers['AbscencesDeclarer']?.text=data['AbscencesDeclarer'].toString();
            this.inputControllers['EtatsDeclarer']?.text=data['EtatsDeclarer'].toString();
            this.inputControllers['Totalpresent']?.text=data['Totalpresent'].toString();
            this.inputControllers['J1']?.text=data['J1'].toString();
            this.inputControllers['J2']?.text=data['J2'].toString();
            this.inputControllers['J3']?.text=data['J3'].toString();
            this.inputControllers['J4']?.text=data['J4'].toString();
            this.inputControllers['J5']?.text=data['J5'].toString();
            this.inputControllers['J6']?.text=data['J6'].toString();
            this.inputControllers['J7']?.text=data['J7'].toString();
            this.inputControllers['J8']?.text=data['J8'].toString();
            this.inputControllers['J9']?.text=data['J9'].toString();
            this.inputControllers['J10']?.text=data['J10'].toString();
            this.inputControllers['J11']?.text=data['J11'].toString();
            this.inputControllers['J12']?.text=data['J12'].toString();
            this.inputControllers['J13']?.text=data['J13'].toString();
            this.inputControllers['J14']?.text=data['J14'].toString();
            this.inputControllers['J15']?.text=data['J15'].toString();
            this.inputControllers['J16']?.text=data['J16'].toString();
            this.inputControllers['J17']?.text=data['J17'].toString();
            this.inputControllers['J18']?.text=data['J18'].toString();
            this.inputControllers['J19']?.text=data['J19'].toString();
            this.inputControllers['J20']?.text=data['J20'].toString();
            this.inputControllers['J21']?.text=data['J21'].toString();
            this.inputControllers['J22']?.text=data['J22'].toString();
            this.inputControllers['J23']?.text=data['J23'].toString();
            this.inputControllers['J24']?.text=data['J24'].toString();
            this.inputControllers['J25']?.text=data['J25'].toString();
            this.inputControllers['J26']?.text=data['J26'].toString();
            this.inputControllers['J27']?.text=data['J27'].toString();
            this.inputControllers['J28']?.text=data['J28'].toString();
            this.inputControllers['J29']?.text=data['J29'].toString();
            this.inputControllers['J30']?.text=data['J30'].toString();
            this.inputControllers['J31']?.text=data['J31'].toString();
            this.inputControllers['deja_annaliser']?.text=data['deja_annaliser'].toString();
            this.inputControllers['pointages_rattacher_auto']?.text=data['pointages_rattacher_auto'].toString();
            this.inputControllers['pointages_rattacher_manuel']?.text=data['pointages_rattacher_manuel'].toString();
            this.inputControllers['pointages_debut_auto']?.text=data['pointages_debut_auto'].toString();
            this.inputControllers['pointages_debut_manuel']?.text=data['pointages_debut_manuel'].toString();
            this.inputControllers['pointages_fin_auto']?.text=data['pointages_fin_auto'].toString();
            this.inputControllers['pointages_fin_manuel']?.text=data['pointages_fin_manuel'].toString();
            this.inputControllers['presence_declarer_auto']?.text=data['presence_declarer_auto'].toString();
            this.inputControllers['presence_declarer_manuel']?.text=data['presence_declarer_manuel'].toString();
            this.inputControllers['programmationsronde_id']?.text=data['programmationsronde_id'].toString();
    ...
    await db.table('programmesrondes').where('id','=',id).update(data);
    var allProgrammesrondes=await db.table('programmesrondes').get();
    print('allProgrammesrondes');
    print(allProgrammesrondes);
    ...
    void resetForm () {
            ...
            this.inputControllers['programmationsronde_id']?.text="";
    ...
    Map<String ,dynamic> getForm () {
        return {
                    ...
                    'programmationsronde_id' : this.inputControllers['programmationsronde_id']?.text,
