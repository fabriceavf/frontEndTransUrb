...
class ProgrammesrondesCardScreen extends StatelessWidget {
int? id = 0;
Map data;
    List<dynamic> horairesData=[];
            List<dynamic> postesData=[];
            List<dynamic> programmationsrondesData=[];
            List<dynamic> programmationsusersData=[];
            List<dynamic> usersData=[];
                ProgrammesrondesCardScreen({Key? key,required this.data}) {
            try {
            ...
            final ProgrammesrondesCardState state = Get.put(ProgrammesrondesCardState());
        return BlocsWidget(
        child:Column(children: <Widget>[
            ...
            children: <Widget>[
                ...
                class ProgrammesrondesCardState extends GetxController {
                var errors= [].obs;
                ...
                var data=getForm();
                DioInstance.post('/api/programmesrondes', data).then((response) {
                ...
                void resetForm () {
                                    ...
                                    formProgrammationsronde_id.value="";
                                    formUser_id.value="";
                                    formCreat_by.value="";
                ...
                return {
                                    ...
                                    'programmationsronde_id' : formProgrammationsronde_id.value,
