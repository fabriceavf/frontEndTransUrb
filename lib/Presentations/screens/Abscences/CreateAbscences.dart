...
class CreateAbscencesScreen extends StatelessWidget {
int? id = 0;

CreateAbscencesScreen({Key? key }){
    try {
...
final CreateAbscencesState state = Get.put(CreateAbscencesState());
...
body:
    ...
    child: Text('Creer un Abscences',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateAbscencesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('abscences').add(data);
