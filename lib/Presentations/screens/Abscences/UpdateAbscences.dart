...
class UpdateAbscencesScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateAbscencesScreen({Key? key ,required this.data}){
try {
...
final UpdateAbscencesState state = Get.put(UpdateAbscencesState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Abscences',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
            ...
            FieldSelectWidget(
        label: "typesabscences",
        detail: "Veuillez selectionner typesabscences",
        placeHolder: "",
        baseData: [],
        model: state.formTypesabscence_id,
        url:'typesabscences-Aggrid',
        filterFields:[ ],
    ...
    class UpdateAbscencesState extends GetxController {
    var errors= [].obs;
    var isLoading= false.obs;
        ...
        var inputControllers={
            ...
            'typesabscence_id':TextEditingController(),
    ...
    void setData(data){
            ...
            this.inputControllers['typesabscence_id']?.text=data['typesabscence_id'].toString();
            ...
            this.inputControllers['valide']?.text=data['valide'].toString();
    ...
    await db.table('abscences').where('id','=',id).update(data);
    var allAbscences=await db.table('abscences').get();
    print('allAbscences');
    print(allAbscences);
    ...
    void resetForm () {
            ...
            this.inputControllers['typesabscence_id']?.text="";
    ...
    Map<String ,dynamic> getForm () {
        return {
                    ...
                    'typesabscence_id' : this.inputControllers['typesabscence_id']?.text,
