...
class CreateDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final CreateDetailsState state = Get.put(CreateDetailsState());
...
class CreateDetailsState extends GetxController {
  var errors = [].obs;
...
// TODO: implement onInit
  ...
  void createLine() async {
    ...
    await db.table('details').add(data);
