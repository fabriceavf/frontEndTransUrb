...
import './ListesappelsCard.dart';
import './CreateListesappels.dart';
import './UpdateListesappels.dart';

class ListesappelsScreen extends StatelessWidget {
int? id = 0;
ListesappelsScreen({Key? key}) {
try {
...
final ListesappelsState c = Get.put(ListesappelsState());
return Scaffold(
appBar: AppBar(
backgroundColor: Theme.of(context).colorScheme.inversePrimary,
title: Text(' Listesappels '),
),
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateListesappelsScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateListesappelsScreen(),barrierDismissible: false);},
table:'listesappels',
...
class ListesappelsState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="listesappels".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/listesappels-Aggrid'.obs;
var table= 'listesappels'.obs;
var requette= 0.obs;
