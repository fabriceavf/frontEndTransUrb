...
class CreateListesappelsScreen extends StatelessWidget {
int? id = 0;

CreateListesappelsScreen({Key? key }){
    try {
...
final CreateListesappelsState state = Get.put(CreateListesappelsState());
...
body:
    ...
    child: Text('Creer un Listesappels',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateListesappelsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('listesappels').add(data);
