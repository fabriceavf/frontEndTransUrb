...
class CreateUserszonesScreen extends StatelessWidget {
int? id = 0;

CreateUserszonesScreen({Key? key }){
    try {
...
final CreateUserszonesState state = Get.put(CreateUserszonesState());
...
body:
    ...
    child: Text('Creer un Userszones',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateUserszonesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('userszones').add(data);
