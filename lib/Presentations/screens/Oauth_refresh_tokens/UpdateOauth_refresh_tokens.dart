...
class UpdateOauth_refresh_tokensScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateOauth_refresh_tokensScreen({Key? key ,required this.data}){
try {
...
final UpdateOauth_refresh_tokensState state = Get.put(UpdateOauth_refresh_tokensState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Oauth_refresh_tokens',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateOauth_refresh_tokensState extends GetxController {
    var errors= [].obs;
    var isLoading= false.obs;

            var formId="".obs;
            var formAccess_token_id="".obs;
            var formRevoked="".obs;
        ...
        var inputControllers={
            ...
            'access_token_id':TextEditingController(),
    ...
    void setData(data){
            ...
            this.inputControllers['access_token_id']?.text=data['access_token_id'].toString();
    ...
    await db.table('oauth_refresh_tokens').where('id','=',id).update(data);
    var allOauth_refresh_tokens=await db.table('oauth_refresh_tokens').get();
    print('allOauth_refresh_tokens');
    print(allOauth_refresh_tokens);
    ...
    void resetForm () {
            ...
            this.inputControllers['access_token_id']?.text="";
    ...
    Map<String ,dynamic> getForm () {
        return {
                    ...
                    'access_token_id' : this.inputControllers['access_token_id']?.text,
