...
class CreateListesappelsjoursScreen extends StatelessWidget {
int? id = 0;

CreateListesappelsjoursScreen({Key? key }){
    try {
...
final CreateListesappelsjoursState state = Get.put(CreateListesappelsjoursState());
...
body:
    ...
    child: Text('Creer un Listesappelsjours',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateListesappelsjoursState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('listesappelsjours').add(data);
