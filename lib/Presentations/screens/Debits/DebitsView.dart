...
import './DebitsCard.dart';
import './CreateDebits.dart';
import './UpdateDebits.dart';

class DebitsScreen extends StatelessWidget {
  int? id = 0;

  DebitsScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final DebitsState c = Get.put(DebitsState());
    return Scaffold(
      appBar: AppBar(
          ...
          children: [
            AggridScreen(
              ...
              fields: [
                {
                  ...
                  'render': (data) => DataCell(ButtonWidget(
                        ...
                        text: 'Edit',
                        onTapCallBack: () {
                          Services.ShowModal(UpdateDebitsScreen(data: data),
              ...
              newElementInitCallback: () {
                Services.ShowModal(CreateDebitsScreen(),
                    barrierDismissible: false);
              },
              table: 'debits',
...
class DebitsState extends GetxController {
  var isLoading = false.obs;
  var gridApi = null.obs;
  var count = 0.obs;
  var formId = "debits".obs;
  var formData = {}.obs;
  var formState = "".obs;
  var formWidth = 'lg'.obs;
  var formKey = 0.obs;
  var tableKey = 0.obs;
  var url = 'http://127.0.0.1:8000/api/debits-Aggrid'.obs;
  var table = 'debits'.obs;
