...
class CreateDebitsScreen extends StatelessWidget {
  int? id = 0;

  CreateDebitsScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final CreateDebitsState state = Get.put(CreateDebitsState());
...
class CreateDebitsState extends GetxController {
  var errors = [].obs;
...
// TODO: implement onInit
  ...
  void createLine() async {
    ...
    await db.table('debits').add(data);
