...
class CreateAttributionsScreen extends StatelessWidget {
int? id = 0;

CreateAttributionsScreen({Key? key }){
    try {
...
final CreateAttributionsState state = Get.put(CreateAttributionsState());
...
body:
    ...
    child: Text('Creer un Attributions',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateAttributionsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('attributions').add(data);
