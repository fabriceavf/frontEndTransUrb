...
import './AttributionsCard.dart';
import './CreateAttributions.dart';
import './UpdateAttributions.dart';
...
final AttributionsState c = Get.put(AttributionsState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateAttributionsScreen(data:data),barrierDismissible: false);},
)
),

},
{
'libelle':'ressource_id',
'render':(data)=>DataCell(Text(data['ressource_id'].toString())),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateAttributionsScreen(),barrierDismissible: false);},
table:'attributions',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['ressource_id'].toString())),DataCell(Text(data['user_id'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['creat_by'].toString())),],
    ),),],),
),
...
class AttributionsState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="attributions".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/attributions-Aggrid'.obs;
var table= 'attributions'.obs;
        var ressourcesData=[].obs;
        var usersData=[].obs;
var requette= 2.obs;
