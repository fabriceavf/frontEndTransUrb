...
class UpdateFormsdatasScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateFormsdatasScreen({Key? key ,required this.data}){
try {
...
final UpdateFormsdatasState state = Get.put(UpdateFormsdatasState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Formsdatas',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateFormsdatasState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['form_id']?.text=data['form_id'].toString();
            this.inputControllers['cle0']?.text=data['cle0'].toString();
            this.inputControllers['cle1']?.text=data['cle1'].toString();
            this.inputControllers['cle2']?.text=data['cle2'].toString();
            this.inputControllers['cle3']?.text=data['cle3'].toString();
            this.inputControllers['cle4']?.text=data['cle4'].toString();
            this.inputControllers['cle5']?.text=data['cle5'].toString();
            this.inputControllers['cle6']?.text=data['cle6'].toString();
            this.inputControllers['cle7']?.text=data['cle7'].toString();
            this.inputControllers['cle8']?.text=data['cle8'].toString();
            this.inputControllers['cle9']?.text=data['cle9'].toString();
            this.inputControllers['cle10']?.text=data['cle10'].toString();
            this.inputControllers['cle11']?.text=data['cle11'].toString();
            this.inputControllers['cle12']?.text=data['cle12'].toString();
            this.inputControllers['cle13']?.text=data['cle13'].toString();
            this.inputControllers['cle14']?.text=data['cle14'].toString();
            this.inputControllers['cle15']?.text=data['cle15'].toString();
            this.inputControllers['cle16']?.text=data['cle16'].toString();
            this.inputControllers['cle17']?.text=data['cle17'].toString();
            this.inputControllers['cle18']?.text=data['cle18'].toString();
            this.inputControllers['cle19']?.text=data['cle19'].toString();
            this.inputControllers['cle20']?.text=data['cle20'].toString();
            this.inputControllers['cle21']?.text=data['cle21'].toString();
            this.inputControllers['cle22']?.text=data['cle22'].toString();
            this.inputControllers['cle23']?.text=data['cle23'].toString();
            this.inputControllers['cle24']?.text=data['cle24'].toString();
            this.inputControllers['cle25']?.text=data['cle25'].toString();
            this.inputControllers['cle26']?.text=data['cle26'].toString();
            this.inputControllers['cle27']?.text=data['cle27'].toString();
            this.inputControllers['cle28']?.text=data['cle28'].toString();
            this.inputControllers['cle29']?.text=data['cle29'].toString();
            this.inputControllers['cle30']?.text=data['cle30'].toString();
            this.inputControllers['cle31']?.text=data['cle31'].toString();
            this.inputControllers['cle32']?.text=data['cle32'].toString();
            this.inputControllers['cle33']?.text=data['cle33'].toString();
            this.inputControllers['cle34']?.text=data['cle34'].toString();
            this.inputControllers['cle35']?.text=data['cle35'].toString();
            this.inputControllers['cle36']?.text=data['cle36'].toString();
            this.inputControllers['cle37']?.text=data['cle37'].toString();
            this.inputControllers['cle38']?.text=data['cle38'].toString();
            this.inputControllers['cle39']?.text=data['cle39'].toString();
            this.inputControllers['cle40']?.text=data['cle40'].toString();
            this.inputControllers['cle41']?.text=data['cle41'].toString();
            this.inputControllers['cle42']?.text=data['cle42'].toString();
            this.inputControllers['cle43']?.text=data['cle43'].toString();
            this.inputControllers['cle44']?.text=data['cle44'].toString();
            this.inputControllers['cle45']?.text=data['cle45'].toString();
            this.inputControllers['cle46']?.text=data['cle46'].toString();
            this.inputControllers['cle47']?.text=data['cle47'].toString();
            this.inputControllers['cle48']?.text=data['cle48'].toString();
            this.inputControllers['cle49']?.text=data['cle49'].toString();
            this.inputControllers['cle50']?.text=data['cle50'].toString();
            this.inputControllers['cle51']?.text=data['cle51'].toString();
            this.inputControllers['cle52']?.text=data['cle52'].toString();
            this.inputControllers['cle53']?.text=data['cle53'].toString();
            this.inputControllers['cle54']?.text=data['cle54'].toString();
            this.inputControllers['cle55']?.text=data['cle55'].toString();
            this.inputControllers['cle56']?.text=data['cle56'].toString();
            this.inputControllers['cle57']?.text=data['cle57'].toString();
            this.inputControllers['cle58']?.text=data['cle58'].toString();
            this.inputControllers['cle59']?.text=data['cle59'].toString();
            this.inputControllers['cle60']?.text=data['cle60'].toString();
            this.inputControllers['cle61']?.text=data['cle61'].toString();
            this.inputControllers['cle62']?.text=data['cle62'].toString();
            this.inputControllers['cle63']?.text=data['cle63'].toString();
            this.inputControllers['cle64']?.text=data['cle64'].toString();
            this.inputControllers['cle65']?.text=data['cle65'].toString();
            this.inputControllers['cle66']?.text=data['cle66'].toString();
            this.inputControllers['cle67']?.text=data['cle67'].toString();
            this.inputControllers['cle68']?.text=data['cle68'].toString();
            this.inputControllers['cle69']?.text=data['cle69'].toString();
            this.inputControllers['cle70']?.text=data['cle70'].toString();
            this.inputControllers['cle71']?.text=data['cle71'].toString();
            this.inputControllers['cle72']?.text=data['cle72'].toString();
            this.inputControllers['cle73']?.text=data['cle73'].toString();
            this.inputControllers['cle74']?.text=data['cle74'].toString();
            this.inputControllers['cle75']?.text=data['cle75'].toString();
            this.inputControllers['cle76']?.text=data['cle76'].toString();
            this.inputControllers['cle77']?.text=data['cle77'].toString();
            this.inputControllers['cle78']?.text=data['cle78'].toString();
            this.inputControllers['cle79']?.text=data['cle79'].toString();
            this.inputControllers['cle80']?.text=data['cle80'].toString();
            this.inputControllers['cle81']?.text=data['cle81'].toString();
            this.inputControllers['cle82']?.text=data['cle82'].toString();
            this.inputControllers['cle83']?.text=data['cle83'].toString();
            this.inputControllers['cle84']?.text=data['cle84'].toString();
            this.inputControllers['cle85']?.text=data['cle85'].toString();
            this.inputControllers['cle86']?.text=data['cle86'].toString();
            this.inputControllers['cle87']?.text=data['cle87'].toString();
            this.inputControllers['cle88']?.text=data['cle88'].toString();
            this.inputControllers['cle89']?.text=data['cle89'].toString();
            this.inputControllers['cle90']?.text=data['cle90'].toString();
            this.inputControllers['cle91']?.text=data['cle91'].toString();
            this.inputControllers['cle92']?.text=data['cle92'].toString();
            this.inputControllers['cle93']?.text=data['cle93'].toString();
            this.inputControllers['cle94']?.text=data['cle94'].toString();
            this.inputControllers['cle95']?.text=data['cle95'].toString();
            this.inputControllers['cle96']?.text=data['cle96'].toString();
            this.inputControllers['cle97']?.text=data['cle97'].toString();
            this.inputControllers['cle98']?.text=data['cle98'].toString();
            this.inputControllers['cle99']?.text=data['cle99'].toString();
    ...
    await db.table('formsdatas').where('id','=',id).update(data);
