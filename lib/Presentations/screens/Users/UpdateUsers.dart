...
class UpdateUsersScreen extends StatelessWidget {
  ...
  UpdateUsersScreen({Key? key, required this.data}) {
    try {
  ...
  Widget build(BuildContext context) {
    final UpdateUsersState state = Get.put(UpdateUsersState());
    state.setData(data);
...
class UpdateUsersState extends GetxController {
  var errors = [].obs;
  ...
  void setData(data) {
    ...
    this.inputControllers['num_badge']?.text = data['num_badge'].toString();
    this.inputControllers['date_naissance']?.text =
        data['date_naissance'].toString();
    this.inputControllers['num_cnss']?.text = data['num_cnss'].toString();
    this.inputControllers['num_cnamgs']?.text = data['num_cnamgs'].toString();
    this.inputControllers['telephone1']?.text = data['telephone1'].toString();
    this.inputControllers['telephone2']?.text = data['telephone2'].toString();
    this.inputControllers['photo']?.text = data['photo'].toString();
    this.inputControllers['date_embauche']?.text =
        data['date_embauche'].toString();
    this.inputControllers['download_date']?.text =
        data['download_date'].toString();
    this.inputControllers['actif_id']?.text = data['actif_id'].toString();
    this.inputControllers['nationalite_id']?.text =
        data['nationalite_id'].toString();
    this.inputControllers['contrat_id']?.text = data['contrat_id'].toString();
    this.inputControllers['direction_id']?.text =
        data['direction_id'].toString();
    this.inputControllers['categorie_id']?.text =
        data['categorie_id'].toString();
    ...
    this.inputControllers['email_verified_at']?.text =
        data['email_verified_at'].toString();
    ...
    this.inputControllers['nombre_enfant']?.text =
        data['nombre_enfant'].toString();
    this.inputControllers['num_dossier']?.text = data['num_dossier'].toString();
    this.inputControllers['online_id']?.text = data['online_id'].toString();
    this.inputControllers['type_id']?.text = data['type_id'].toString();
    this.inputControllers['faction_id']?.text = data['faction_id'].toString();
    this.inputControllers['remember_token']?.text =
        data['remember_token'].toString();
    ...
    this.inputControllers['role_id']?.text = data['role_id'].toString();
    ...
    this.inputControllers['typeseffectif_id']?.text =
        data['typeseffectif_id'].toString();
  }
