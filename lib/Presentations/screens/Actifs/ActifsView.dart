...
import './ActifsCard.dart';
import './CreateActifs.dart';
import './UpdateActifs.dart';

class ActifsScreen extends StatelessWidget {
  int? id = 0;

  ActifsScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final ActifsState c = Get.put(ActifsState());
    return Scaffold(
      appBar: AppBar(
          ...
          children: [
            AggridScreen(
              ...
              fields: [
                {
                  ...
                  'render': (data) => DataCell(ButtonWidget(
                        ...
                        text: 'Edit',
                        onTapCallBack: () {
                          Services.ShowModal(UpdateActifsScreen(data: data),
              ...
              newElementInitCallback: () {
                Services.ShowModal(CreateActifsScreen(),
                    barrierDismissible: false);
              },
              table: 'actifs',
...
class ActifsState extends GetxController {
  var isLoading = false.obs;
  var gridApi = null.obs;
  var count = 0.obs;
  var formId = "actifs".obs;
  var formData = {}.obs;
  var formState = "".obs;
  var formWidth = 'lg'.obs;
  var formKey = 0.obs;
  var tableKey = 0.obs;
  var url = 'http://127.0.0.1:8000/api/actifs-Aggrid'.obs;
  var table = 'actifs'.obs;
  var requette = 0.obs;
