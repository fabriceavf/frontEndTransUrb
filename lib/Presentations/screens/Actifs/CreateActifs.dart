...
class CreateActifsScreen extends StatelessWidget {
  int? id = 0;

  CreateActifsScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final CreateActifsState state = Get.put(CreateActifsState());
...
class CreateActifsState extends GetxController {
  var errors = [].obs;
...
// TODO: implement onInit
  ...
  void createLine() async {
    ...
    await db.table('actifs').add(data);
