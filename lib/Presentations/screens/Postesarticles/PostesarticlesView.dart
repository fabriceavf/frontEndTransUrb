...
import './PostesarticlesCard.dart';
import './CreatePostesarticles.dart';
import './UpdatePostesarticles.dart';

class PostesarticlesScreen extends StatelessWidget {
int? id = 0;
PostesarticlesScreen({Key? key}) {
try {
...
final PostesarticlesState c = Get.put(PostesarticlesState());
return Scaffold(
appBar: AppBar(
backgroundColor: Theme.of(context).colorScheme.inversePrimary,
title: Text(' Postesarticles '),
),
drawer: DrawerAdmin(),
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdatePostesarticlesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['deleted_at'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreatePostesarticlesScreen(),barrierDismissible: false);},
...
class PostesarticlesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="postesarticles".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/postesarticles-Aggrid'.obs;
var table= 'postesarticles'.obs;
var requette= 0.obs;
