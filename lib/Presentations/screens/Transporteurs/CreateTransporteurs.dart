...
class CreateTransporteursScreen extends StatelessWidget {
int? id = 0;

CreateTransporteursScreen({Key? key }){
    try {
...
final CreateTransporteursState state = Get.put(CreateTransporteursState());
...
body:
    ...
    child: Text('Creer un Transporteurs',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateTransporteursState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('transporteurs').add(data);
