...
class CreateVariablesScreen extends StatelessWidget {
int? id = 0;

CreateVariablesScreen({Key? key }){
    try {
...
final CreateVariablesState state = Get.put(CreateVariablesState());
...
body:
    ...
    child: Text('Creer un Variables',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateVariablesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('variables').add(data);
