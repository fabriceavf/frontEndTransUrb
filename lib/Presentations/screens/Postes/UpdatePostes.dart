...
class UpdatePostesScreen extends StatelessWidget {
  int? id = 0;
  Map data;

  UpdatePostesScreen({Key? key, required this.data}) {
    try {
  ...
  Widget build(BuildContext context) {
    final UpdatePostesState state = Get.put(UpdatePostesState());
    state.setData(data);
...
class UpdatePostesState extends GetxController {
  var errors = [].obs;
  ...
  void setData(data) {
    ...
    this.inputControllers['nature']?.text = data['nature'].toString();
    this.inputControllers['coordonnees']?.text = data['coordonnees'].toString();
    ...
    this.inputControllers['contratsclient_id']?.text =
        data['contratsclient_id'].toString();
    ...
    this.inputControllers['typeagents']?.text = data['typeagents'].toString();
  ...
  void UpdateLine() async {
    ...
    await db.table('postes').where('id', '=', id).update(data);
