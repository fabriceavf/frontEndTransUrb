...
class CreateVehiculesScreen extends StatelessWidget {
int? id = 0;

CreateVehiculesScreen({Key? key }){
    try {
...
final CreateVehiculesState state = Get.put(CreateVehiculesState());
...
body:
    ...
    child: Text('Creer un Vehicules',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateVehiculesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('vehicules').add(data);
