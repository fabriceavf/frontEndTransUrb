...
class CreateListingsetatsScreen extends StatelessWidget {
int? id = 0;

CreateListingsetatsScreen({Key? key }){
    try {
...
final CreateListingsetatsState state = Get.put(CreateListingsetatsState());
...
body:
    ...
    child: Text('Creer un Listingsetats',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateListingsetatsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('listingsetats').add(data);
