...
class CreateListingsjoursScreen extends StatelessWidget {
int? id = 0;

CreateListingsjoursScreen({Key? key }){
    try {
...
final CreateListingsjoursState state = Get.put(CreateListingsjoursState());
...
body:
    ...
    child: Text('Creer un Listingsjours',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateListingsjoursState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('listingsjours').add(data);
