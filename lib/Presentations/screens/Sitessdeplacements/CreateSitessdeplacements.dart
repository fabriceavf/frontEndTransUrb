...
class CreateSitessdeplacementsScreen extends StatelessWidget {
int? id = 0;

CreateSitessdeplacementsScreen({Key? key }){
    try {
...
final CreateSitessdeplacementsState state = Get.put(CreateSitessdeplacementsState());
...
body:
    ...
    child: Text('Creer un Sitessdeplacements',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateSitessdeplacementsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('sitessdeplacements').add(data);
