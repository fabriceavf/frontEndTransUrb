...
class CreateCreditsScreen extends StatelessWidget {
  int? id = 0;

  CreateCreditsScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final CreateCreditsState state = Get.put(CreateCreditsState());
...
class CreateCreditsState extends GetxController {
  var errors = [].obs;
...
// TODO: implement onInit
  ...
  void createLine() async {
    ...
    await db.table('credits').add(data);
