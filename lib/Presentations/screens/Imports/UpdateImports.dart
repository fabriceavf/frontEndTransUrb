...
class UpdateImportsScreen extends StatelessWidget {
  int? id = 0;
  Map data;

  UpdateImportsScreen({Key? key, required this.data}) {
    try {
  ...
  Widget build(BuildContext context) {
    final UpdateImportsState state = Get.put(UpdateImportsState());
    state.setData(data);
...
class UpdateImportsState extends GetxController {
  var errors = [].obs;
  ...
  void setData(data) {
    ...
    this.inputControllers['liaisons']?.text = data['liaisons'].toString();
    this.inputControllers['identifiant']?.text = data['identifiant'].toString();
    ...
    this.inputControllers['file']?.text = data['file'].toString();
    this.inputControllers['newtables']?.text = data['newtables'].toString();
    this.inputControllers['create']?.text = data['create'].toString();
    this.inputControllers['update']?.text = data['update'].toString();
    this.inputControllers['delete']?.text = data['delete'].toString();
  ...
  void UpdateLine() async {
    ...
    await db.table('imports').where('id', '=', id).update(data);
