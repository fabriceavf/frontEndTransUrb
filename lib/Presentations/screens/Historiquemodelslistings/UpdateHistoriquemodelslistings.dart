...
class UpdateHistoriquemodelslistingsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateHistoriquemodelslistingsScreen({Key? key ,required this.data}){
try {
...
final UpdateHistoriquemodelslistingsState state = Get.put(UpdateHistoriquemodelslistingsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Historiquemodelslistings',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateHistoriquemodelslistingsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['modelisting_id']?.text=data['modelisting_id'].toString();
    ...
    await db.table('historiquemodelslistings').where('id','=',id).update(data);
