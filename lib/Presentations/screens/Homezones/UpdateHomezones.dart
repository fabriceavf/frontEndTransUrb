...
class UpdateHomezonesScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateHomezonesScreen({Key? key ,required this.data}){
try {
...
final UpdateHomezonesState state = Get.put(UpdateHomezonesState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Homezones',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateHomezonesState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['modelslisting']?.text=data['modelslisting'].toString();
            this.inputControllers['effectifsjour']?.text=data['effectifsjour'].toString();
            this.inputControllers['presentsjour']?.text=data['presentsjour'].toString();
            this.inputControllers['effectifsnuit']?.text=data['effectifsnuit'].toString();
            this.inputControllers['presentsnuit']?.text=data['presentsnuit'].toString();
    ...
    await db.table('homezones').where('id','=',id).update(data);
