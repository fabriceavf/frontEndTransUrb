...
class CreateApprovisionementdetailsScreen extends StatelessWidget {
int? id = 0;

CreateApprovisionementdetailsScreen({Key? key }){
    try {
...
final CreateApprovisionementdetailsState state = Get.put(CreateApprovisionementdetailsState());
...
body:
    ...
    child: Text('Creer un Approvisionementdetails',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateApprovisionementdetailsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('approvisionementdetails').add(data);
