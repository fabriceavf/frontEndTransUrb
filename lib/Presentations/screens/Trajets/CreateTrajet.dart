...
class TrajetCreate extends StatelessWidget {
  late TrajetCreateState state;
  late final _formKey;

  TrajetCreate({super.key}) {
    state = Get.put<TrajetCreateState>(TrajetCreateState());
...
class TrajetCreateState extends GetxController {
  ...
  void addElement(libelle, description) async {
    final TrajetState c = Get.find<TrajetState>();
