...
class CreateMatrimonialesScreen extends StatelessWidget {
int? id = 0;

CreateMatrimonialesScreen({Key? key }){
    try {
...
final CreateMatrimonialesState state = Get.put(CreateMatrimonialesState());
...
body:
    ...
    child: Text('Creer un Matrimoniales',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateMatrimonialesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('matrimoniales').add(data);
