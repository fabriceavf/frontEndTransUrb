...
class CreateUserbadgesScreen extends StatelessWidget {
int? id = 0;

CreateUserbadgesScreen({Key? key }){
    try {
...
final CreateUserbadgesState state = Get.put(CreateUserbadgesState());
...
body:
    ...
    child: Text('Creer un Userbadges',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateUserbadgesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('userbadges').add(data);
