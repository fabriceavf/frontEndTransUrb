...
import './UserbadgesCard.dart';
import './CreateUserbadges.dart';
import './UpdateUserbadges.dart';

class UserbadgesScreen extends StatelessWidget {
int? id = 0;
UserbadgesScreen({Key? key}) {
try {
...
final UserbadgesState c = Get.put(UserbadgesState());
return Scaffold(
appBar: AppBar(
backgroundColor: Theme.of(context).colorScheme.inversePrimary,
title: Text(' Userbadges '),
),
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateUserbadgesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateUserbadgesScreen(),barrierDismissible: false);},
table:'userbadges',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['user_id'].toString())),DataCell(Text(data['num_badge'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['creat_by'].toString())),],
    ),),],),
),
...
class UserbadgesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="userbadges".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/userbadges-Aggrid'.obs;
var table= 'userbadges'.obs;
        var usersData=[].obs;
var requette= 1.obs;
