...
class CreatePostesagentsScreen extends StatelessWidget {
int? id = 0;

CreatePostesagentsScreen({Key? key }){
    try {
...
final CreatePostesagentsState state = Get.put(CreatePostesagentsState());
...
body:
    ...
    child: Text('Creer un Postesagents',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreatePostesagentsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('postesagents').add(data);
