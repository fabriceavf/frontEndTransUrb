...
import './RolesCard.dart';
import './CreateRoles.dart';
import './UpdateRoles.dart';
...
class RolesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final RolesState c = Get.put(RolesState());
    return Scaffold(
      appBar: AppBar(
          ...
          children: [
            AggridScreen(
              ...
              fields: [
                {
                  ...
                  'render': (data) => DataCell(ButtonWidget(
                        ...
                        text: 'Edit',
                        onTapCallBack: () {
                          Services.ShowModal(UpdateRolesScreen(data: data),
                ...
                },
                {
                  'libelle': 'guard_name',
                  'render': (data) =>
                      DataCell(Text(data['guard_name'].toString())),
                },
                {
                  'libelle': 'created_at',
                  'render': (data) =>
              ...
              newElementInitCallback: () {
                Services.ShowModal(CreateRolesScreen(),
                    barrierDismissible: false);
              },
              table: 'roles',
...
class RolesState extends GetxController {
  var isLoading = false.obs;
  var gridApi = null.obs;
  var count = 0.obs;
  var formId = "roles".obs;
  var formData = {}.obs;
  var formState = "".obs;
  var formWidth = 'lg'.obs;
  var formKey = 0.obs;
  var tableKey = 0.obs;
  var url = 'http://127.0.0.1:8000/api/roles-Aggrid'.obs;
  var table = 'roles'.obs;
  var requette = 0.obs;
