...
class CreatePassagesrondesScreen extends StatelessWidget {
int? id = 0;

CreatePassagesrondesScreen({Key? key }){
    try {
...
final CreatePassagesrondesState state = Get.put(CreatePassagesrondesState());
...
body:
    ...
    child: Text('Creer un Passagesrondes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreatePassagesrondesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('passagesrondes').add(data);
