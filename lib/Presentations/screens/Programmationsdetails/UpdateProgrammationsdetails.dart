...
class UpdateProgrammationsdetailsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateProgrammationsdetailsScreen({Key? key ,required this.data}){
try {
...
final UpdateProgrammationsdetailsState state = Get.put(UpdateProgrammationsdetailsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Programmationsdetails',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateProgrammationsdetailsState extends GetxController {
    var errors= [].obs;
    ...
    await db.table('programmationsdetails').where('id','=',id).update(data);
