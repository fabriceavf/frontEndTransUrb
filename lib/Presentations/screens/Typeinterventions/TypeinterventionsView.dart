...
import './TypeinterventionsCard.dart';
import './CreateTypeinterventions.dart';
import './UpdateTypeinterventions.dart';

class TypeinterventionsScreen extends StatelessWidget {
int? id = 0;
TypeinterventionsScreen({Key? key}) {
try {
...
final TypeinterventionsState c = Get.put(TypeinterventionsState());
return Scaffold(
appBar: AppBar(
backgroundColor: Theme.of(context).colorScheme.inversePrimary,
title: Text(' Typeinterventions '),
),
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateTypeinterventionsScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateTypeinterventionsScreen(),barrierDismissible: false);},
...
class TypeinterventionsState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="typeinterventions".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/typeinterventions-Aggrid'.obs;
var table= 'typeinterventions'.obs;
var requette= 0.obs;
