...
class CreateTypesheuresScreen extends StatelessWidget {
int? id = 0;

CreateTypesheuresScreen({Key? key }){
    try {
...
final CreateTypesheuresState state = Get.put(CreateTypesheuresState());
...
body:
    ...
    child: Text('Creer un Typesheures',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateTypesheuresState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('typesheures').add(data);
