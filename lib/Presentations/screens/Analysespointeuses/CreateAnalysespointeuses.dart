...
class CreateAnalysespointeusesScreen extends StatelessWidget {
int? id = 0;

CreateAnalysespointeusesScreen({Key? key }){
    try {
...
final CreateAnalysespointeusesState state = Get.put(CreateAnalysespointeusesState());
...
body:
    ...
    child: Text('Creer un Analysespointeuses',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateAnalysespointeusesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('analysespointeuses').add(data);
