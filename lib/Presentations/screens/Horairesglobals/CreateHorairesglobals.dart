...
class CreateHorairesglobalsScreen extends StatelessWidget {
int? id = 0;

CreateHorairesglobalsScreen({Key? key }){
    try {
...
final CreateHorairesglobalsState state = Get.put(CreateHorairesglobalsState());
...
body:
    ...
    child: Text('Creer un Horairesglobals',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateHorairesglobalsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('horairesglobals').add(data);
