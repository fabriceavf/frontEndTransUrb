...
class CreateOauth_access_tokensScreen extends StatelessWidget {
int? id = 0;

CreateOauth_access_tokensScreen({Key? key }){
    try {
...
final CreateOauth_access_tokensState state = Get.put(CreateOauth_access_tokensState());
...
body:
    ...
    child: Text('Creer un Oauth_access_tokens',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateOauth_access_tokensState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('oauth_access_tokens').add(data);
