...
class CreateTravailleursScreen extends StatelessWidget {
int? id = 0;

CreateTravailleursScreen({Key? key }){
    try {
...
final CreateTravailleursState state = Get.put(CreateTravailleursState());
...
body:
    ...
    child: Text('Creer un Travailleurs',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateTravailleursState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('travailleurs').add(data);
