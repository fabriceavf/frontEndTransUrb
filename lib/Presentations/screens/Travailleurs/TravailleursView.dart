...
import './TravailleursCard.dart';
import './CreateTravailleurs.dart';
import './UpdateTravailleurs.dart';

class TravailleursScreen extends StatelessWidget {
int? id = 0;
TravailleursScreen({Key? key}) {
try {
...
final TravailleursState c = Get.put(TravailleursState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateTravailleursScreen(data:data),barrierDismissible: false);},
)
),
...
class TravailleursState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="travailleurs".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/travailleurs-Aggrid'.obs;
var table= 'travailleurs'.obs;
