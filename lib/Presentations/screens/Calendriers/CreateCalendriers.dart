...
class CreateCalendriersScreen extends StatelessWidget {
int? id = 0;

CreateCalendriersScreen({Key? key }){
    try {
...
final CreateCalendriersState state = Get.put(CreateCalendriersState());
...
body:
    ...
    child: Text('Creer un Calendriers',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateCalendriersState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('calendriers').add(data);
