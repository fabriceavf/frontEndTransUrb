...
class CreateAlldatasScreen extends StatelessWidget {
int? id = 0;

CreateAlldatasScreen({Key? key }){
    try {
...
final CreateAlldatasState state = Get.put(CreateAlldatasState());
...
body:
    ...
    child: Text('Creer un Alldatas',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateAlldatasState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('alldatas').add(data);
