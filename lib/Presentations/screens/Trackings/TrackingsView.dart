...
import './TrackingsCard.dart';
import './CreateTrackings.dart';
import './UpdateTrackings.dart';

class TrackingsScreen extends StatelessWidget {
int? id = 0;
TrackingsScreen({Key? key}) {
try {
...
final TrackingsState c = Get.put(TrackingsState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateTrackingsScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['deleted_at'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateTrackingsScreen(),barrierDismissible: false);},
table:'trackings',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['balise_id'].toString())),DataCell(Text(data['moyenstransport_id'].toString())),DataCell(Text(data['date_debut'].toString())),DataCell(Text(data['date_fin'].toString())),DataCell(Text(data['creat_by'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['deleted_at'].toString())),],
    ),),],),
),
...
class TrackingsState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="trackings".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/trackings-Aggrid'.obs;
var table= 'trackings'.obs;
        var balisesData=[].obs;
