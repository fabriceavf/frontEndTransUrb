...
class CreateBalisesScreen extends StatelessWidget {
  int? id = 0;

  CreateBalisesScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final CreateBalisesState state = Get.put(CreateBalisesState());
...
class CreateBalisesState extends GetxController {
  var errors = [].obs;
...
// TODO: implement onInit
  ...
  void createLine() async {
    ...
    await db.table('balises').add(data);
