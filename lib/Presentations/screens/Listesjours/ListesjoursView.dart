...
import './ListesjoursCard.dart';
import './CreateListesjours.dart';
import './UpdateListesjours.dart';

class ListesjoursScreen extends StatelessWidget {
int? id = 0;
ListesjoursScreen({Key? key}) {
try {
...
final ListesjoursState c = Get.put(ListesjoursState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateListesjoursScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateListesjoursScreen(),barrierDismissible: false);},
table:'listesjours',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['rand'].toString())),DataCell(Text(data['jour'].toString())),DataCell(Text(data['listesappel_id'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['creat_by'].toString())),],
    ),),],),
),
...
class ListesjoursState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="listesjours".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/listesjours-Aggrid'.obs;
var table= 'listesjours'.obs;
