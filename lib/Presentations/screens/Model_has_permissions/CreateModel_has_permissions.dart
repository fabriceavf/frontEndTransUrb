...
class CreateModel_has_permissionsScreen extends StatelessWidget {
int? id = 0;

CreateModel_has_permissionsScreen({Key? key }){
    try {
...
final CreateModel_has_permissionsState state = Get.put(CreateModel_has_permissionsState());
...
body:
    ...
    child: Text('Creer un Model_has_permissions',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateModel_has_permissionsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('model_has_permissions').add(data);
