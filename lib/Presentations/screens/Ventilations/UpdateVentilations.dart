...
class UpdateVentilationsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateVentilationsScreen({Key? key ,required this.data}){
try {
...
final UpdateVentilationsState state = Get.put(UpdateVentilationsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Ventilations',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateVentilationsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['dimanche_date']?.text=data['dimanche_date'].toString();
            this.inputControllers['lundi_date']?.text=data['lundi_date'].toString();
            this.inputControllers['mardi_date']?.text=data['mardi_date'].toString();
            this.inputControllers['mercredi_date']?.text=data['mercredi_date'].toString();
            this.inputControllers['jeudi_date']?.text=data['jeudi_date'].toString();
            this.inputControllers['vendredi_date']?.text=data['vendredi_date'].toString();
            this.inputControllers['samedi_date']?.text=data['samedi_date'].toString();
            this.inputControllers['dimanche_horaire']?.text=data['dimanche_horaire'].toString();
            this.inputControllers['lundi_horaire']?.text=data['lundi_horaire'].toString();
            this.inputControllers['mardi_horaire']?.text=data['mardi_horaire'].toString();
            this.inputControllers['mercredi_horaire']?.text=data['mercredi_horaire'].toString();
            this.inputControllers['jeudi_horaire']?.text=data['jeudi_horaire'].toString();
            this.inputControllers['vendredi_horaire']?.text=data['vendredi_horaire'].toString();
            this.inputControllers['samedi_horaire']?.text=data['samedi_horaire'].toString();
            this.inputControllers['dimanche']?.text=data['dimanche'].toString();
            this.inputControllers['lundi']?.text=data['lundi'].toString();
            this.inputControllers['mardi']?.text=data['mardi'].toString();
            this.inputControllers['mercredi']?.text=data['mercredi'].toString();
            this.inputControllers['jeudi']?.text=data['jeudi'].toString();
            this.inputControllers['vendredi']?.text=data['vendredi'].toString();
            this.inputControllers['samedi']?.text=data['samedi'].toString();
            this.inputControllers['dimanche_pointage']?.text=data['dimanche_pointage'].toString();
            this.inputControllers['lundi_pointage']?.text=data['lundi_pointage'].toString();
            this.inputControllers['mardi_pointage']?.text=data['mardi_pointage'].toString();
            this.inputControllers['mercredi_pointage']?.text=data['mercredi_pointage'].toString();
            this.inputControllers['jeudi_pointage']?.text=data['jeudi_pointage'].toString();
            this.inputControllers['vendredi_pointage']?.text=data['vendredi_pointage'].toString();
            this.inputControllers['samedi_pointage']?.text=data['samedi_pointage'].toString();
            this.inputControllers['dimanche_collecter']?.text=data['dimanche_collecter'].toString();
            this.inputControllers['lundi_collecter']?.text=data['lundi_collecter'].toString();
            this.inputControllers['mardi_collecter']?.text=data['mardi_collecter'].toString();
            this.inputControllers['mercredi_collecter']?.text=data['mercredi_collecter'].toString();
            this.inputControllers['jeudi_collecter']?.text=data['jeudi_collecter'].toString();
            this.inputControllers['vendredi_collecter']?.text=data['vendredi_collecter'].toString();
            this.inputControllers['samedi_collecter']?.text=data['samedi_collecter'].toString();
            this.inputControllers['dimanche_depassement']?.text=data['dimanche_depassement'].toString();
            this.inputControllers['lundi_depassement']?.text=data['lundi_depassement'].toString();
            this.inputControllers['mardi_depassement']?.text=data['mardi_depassement'].toString();
            this.inputControllers['mercredi_depassement']?.text=data['mercredi_depassement'].toString();
            this.inputControllers['jeudi_depassement']?.text=data['jeudi_depassement'].toString();
            this.inputControllers['vendredi_depassement']?.text=data['vendredi_depassement'].toString();
            this.inputControllers['samedi_depassement']?.text=data['samedi_depassement'].toString();
            this.inputControllers['dimanche_programmer']?.text=data['dimanche_programmer'].toString();
            this.inputControllers['lundi_programmer']?.text=data['lundi_programmer'].toString();
            this.inputControllers['mardi_programmer']?.text=data['mardi_programmer'].toString();
            this.inputControllers['mercredi_programmer']?.text=data['mercredi_programmer'].toString();
            this.inputControllers['jeudi_programmer']?.text=data['jeudi_programmer'].toString();
            this.inputControllers['vendredi_programmer']?.text=data['vendredi_programmer'].toString();
            this.inputControllers['samedi_programmer']?.text=data['samedi_programmer'].toString();
            this.inputControllers['dimanche_retard']?.text=data['dimanche_retard'].toString();
            this.inputControllers['lundi_retard']?.text=data['lundi_retard'].toString();
            this.inputControllers['mardi_retard']?.text=data['mardi_retard'].toString();
            this.inputControllers['mercredi_retard']?.text=data['mercredi_retard'].toString();
            this.inputControllers['jeudi_retard']?.text=data['jeudi_retard'].toString();
            this.inputControllers['vendredi_retard']?.text=data['vendredi_retard'].toString();
            this.inputControllers['samedi_retard']?.text=data['samedi_retard'].toString();
            this.inputControllers['programmation_id']?.text=data['programmation_id'].toString();
            this.inputControllers['total_programmer']?.text=data['total_programmer'].toString();
            this.inputControllers['total_colecter']?.text=data['total_colecter'].toString();
            this.inputControllers['total_depassement']?.text=data['total_depassement'].toString();
            this.inputControllers['hs15']?.text=data['hs15'].toString();
            this.inputControllers['hs26']?.text=data['hs26'].toString();
            this.inputControllers['hs55']?.text=data['hs55'].toString();
            this.inputControllers['hs30']?.text=data['hs30'].toString();
            this.inputControllers['hs60']?.text=data['hs60'].toString();
            this.inputControllers['hs115']?.text=data['hs115'].toString();
            this.inputControllers['hs130']?.text=data['hs130'].toString();
            this.inputControllers['total']?.text=data['total'].toString();
    ...
    await db.table('ventilations').where('id','=',id).update(data);
