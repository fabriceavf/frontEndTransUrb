...
class CreateSituationsScreen extends StatelessWidget {
int? id = 0;

CreateSituationsScreen({Key? key }){
    try {
...
final CreateSituationsState state = Get.put(CreateSituationsState());
...
body:
    ...
    child: Text('Creer un Situations',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateSituationsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('situations').add(data);
