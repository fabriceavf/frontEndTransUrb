...
class UpdatePointeusesScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdatePointeusesScreen({Key? key ,required this.data}){
try {
...
final UpdatePointeusesState state = Get.put(UpdatePointeusesState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Pointeuses',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdatePointeusesState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['nom_local']?.text=data['nom_local'].toString();
            this.inputControllers['supervirzclient_id']?.text=data['supervirzclient_id'].toString();
            this.inputControllers['code_teleric']?.text=data['code_teleric'].toString();
            this.inputControllers['postes']?.text=data['postes'].toString();
            this.inputControllers['Taches']?.text=data['Taches'].toString();
    ...
    await db.table('pointeuses').where('id','=',id).update(data);
