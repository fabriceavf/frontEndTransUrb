...
class UpdateExportsScreen extends StatelessWidget {
  int? id = 0;
  Map data;

  UpdateExportsScreen({Key? key, required this.data}) {
    try {
  ...
  Widget build(BuildContext context) {
    final UpdateExportsState state = Get.put(UpdateExportsState());
    state.setData(data);
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Obx(() => MyInputWidget(
                      ...
                      valid: 0)),
                  Obx(() => MyInputWidget(
                      controller: state.inputControllers['lien'],
                      label: "lien",
                      placeHolder: "",
                      valid: 0)),
                  Obx(() => MyInputWidget(
...
class UpdateExportsState extends GetxController {
  var errors = [].obs;
  ...
  void setData(data) {
    ...
    this.inputControllers['lien']?.text = data['lien'].toString();
  ...
  void UpdateLine() async {
    ...
    await db.table('exports').where('id', '=', id).update(data);
    var allExports = await db.table('exports').get();
    print('allExports');
    print(allExports);
  }
  ...
  void resetForm() {
    ...
    this.inputControllers['lien']?.text = "";
  ...
  Map<String, dynamic> getForm() {
    return {
      ...
      'lien': this.inputControllers['lien']?.text,
