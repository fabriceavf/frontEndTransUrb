...
class CreateRessourcesScreen extends StatelessWidget {
int? id = 0;

CreateRessourcesScreen({Key? key }){
    try {
...
final CreateRessourcesState state = Get.put(CreateRessourcesState());
...
body:
    ...
    child: Text('Creer un Ressources',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateRessourcesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('ressources').add(data);
