...
import './RessourcesCard.dart';
import './CreateRessources.dart';
import './UpdateRessources.dart';

class RessourcesScreen extends StatelessWidget {
int? id = 0;
RessourcesScreen({Key? key}) {
try {
...
final RessourcesState c = Get.put(RessourcesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateRessourcesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateRessourcesScreen(),barrierDismissible: false);},
table:'ressources',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['type'].toString())),DataCell(Text(data['cle'].toString())),DataCell(Text(data['valeur'].toString())),DataCell(Text(data['activite_id'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['creat_by'].toString())),],
    ),),],),
),
...
class RessourcesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="ressources".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/ressources-Aggrid'.obs;
var table= 'ressources'.obs;
