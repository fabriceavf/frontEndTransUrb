...
class CreateConfigurationsScreen extends StatelessWidget {
  int? id = 0;

  CreateConfigurationsScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final CreateConfigurationsState state =
        Get.put(CreateConfigurationsState());
...
class CreateConfigurationsState extends GetxController {
  var errors = [].obs;
...
// TODO: implement onInit
  ...
  void createLine() async {
    ...
    data.remove("id");
    await DB.table('configurations').setDbname('demoTest').insert(data);
  }
