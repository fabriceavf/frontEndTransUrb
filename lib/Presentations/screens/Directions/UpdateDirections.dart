...
class UpdateDirectionsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateDirectionsScreen({Key? key ,required this.data}){
try {
...
final UpdateDirectionsState state = Get.put(UpdateDirectionsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Directions',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateDirectionsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['groupedirection_id']?.text=data['groupedirection_id'].toString();
    ...
    await db.table('directions').where('id','=',id).update(data);
