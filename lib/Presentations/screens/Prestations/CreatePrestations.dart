...
class CreatePrestationsScreen extends StatelessWidget {
int? id = 0;

CreatePrestationsScreen({Key? key }){
    try {
...
final CreatePrestationsState state = Get.put(CreatePrestationsState());
...
body:
    ...
    child: Text('Creer un Prestations',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreatePrestationsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('prestations').add(data);
