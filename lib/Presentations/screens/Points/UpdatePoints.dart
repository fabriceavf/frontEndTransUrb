...
class UpdatePointsScreen extends StatelessWidget {
  ...
  UpdatePointsScreen({Key? key, required this.data}) {
    try {
  ...
  Widget build(BuildContext context) {
    final UpdatePointsState state = Get.put(UpdatePointsState());
    state.setData(data);
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Obx(() => MyInputWidget(
                      ...
                      valid: 0)),
                  Obx(() => MyInputWidget(
                      controller: state.inputControllers['longitude'],
                      label: "longitude",
                      placeHolder: "",
                      valid: 0)),
                  Obx(() => MyInputWidget(
                      controller: state.inputControllers['latitude'],
                      label: "latitude",
                      placeHolder: "",
                      valid: 0)),
                  Obx(() => MyInputWidget(
...
class UpdatePointsState extends GetxController {
  var errors = [].obs;
  ...
  void UpdateLine() async {
    ...
    await db.table('points').where('id', '=', id).update(data);
    var allPoints = await db.table('points').get();
    print('allPoints');
    print(allPoints);
  }
