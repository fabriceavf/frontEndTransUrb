...
class CreatePointsScreen extends StatelessWidget {
  int? id = 0;

  CreatePointsScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final CreatePointsState state = Get.put(CreatePointsState());
...
class CreatePointsState extends GetxController {
  var errors = [].obs;
...
// TODO: implement onInit
  ...
  void createLine() async {
    ...
    await db.table('points').add(data);
