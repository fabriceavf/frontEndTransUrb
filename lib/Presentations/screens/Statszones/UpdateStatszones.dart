...
class UpdateStatszonesScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateStatszonesScreen({Key? key ,required this.data}){
try {
...
final UpdateStatszonesState state = Get.put(UpdateStatszonesState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Statszones',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateStatszonesState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['nom1']?.text=data['nom1'].toString();
            this.inputControllers['modelslistingnuit1_id']?.text=data['modelslistingnuit1_id'].toString();
            this.inputControllers['modelslistingjour1_id']?.text=data['modelslistingjour1_id'].toString();
            this.inputControllers['nom2']?.text=data['nom2'].toString();
            this.inputControllers['modelslistingnuit2_id']?.text=data['modelslistingnuit2_id'].toString();
            this.inputControllers['modelslistingjour2_id']?.text=data['modelslistingjour2_id'].toString();
            this.inputControllers['nom3']?.text=data['nom3'].toString();
            this.inputControllers['modelslistingnuit3_id']?.text=data['modelslistingnuit3_id'].toString();
            this.inputControllers['modelslistingjour3_id']?.text=data['modelslistingjour3_id'].toString();
            ...
            this.inputControllers['modelslistingnuit1']?.text=data['modelslistingnuit1'].toString();
            this.inputControllers['modelslistingnuit2']?.text=data['modelslistingnuit2'].toString();
            this.inputControllers['modelslistingnuit3']?.text=data['modelslistingnuit3'].toString();
            this.inputControllers['modelslistingjour1']?.text=data['modelslistingjour1'].toString();
            this.inputControllers['modelslistingjour2']?.text=data['modelslistingjour2'].toString();
            this.inputControllers['modelslistingjour3']?.text=data['modelslistingjour3'].toString();
    ...
    await db.table('statszones').where('id','=',id).update(data);
