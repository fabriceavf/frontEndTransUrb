...
class CreateTypestachesScreen extends StatelessWidget {
int? id = 0;

CreateTypestachesScreen({Key? key }){
    try {
...
final CreateTypestachesState state = Get.put(CreateTypestachesState());
...
body:
    ...
    child: Text('Creer un Typestaches',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateTypestachesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('typestaches').add(data);
