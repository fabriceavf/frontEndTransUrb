...
class CreateMaterielinterventiondetailsScreen extends StatelessWidget {
int? id = 0;

CreateMaterielinterventiondetailsScreen({Key? key }){
    try {
...
final CreateMaterielinterventiondetailsState state = Get.put(CreateMaterielinterventiondetailsState());
...
body:
    ...
    child: Text('Creer un Materielinterventiondetails',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateMaterielinterventiondetailsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('materielinterventiondetails').add(data);
