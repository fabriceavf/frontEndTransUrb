...
class CreateClientsScreen extends StatelessWidget {
  int? id = 0;

  CreateClientsScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final CreateClientsState state = Get.put(CreateClientsState());
...
class CreateClientsState extends GetxController {
  var errors = [].obs;
