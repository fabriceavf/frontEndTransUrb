...
import './CreateClients.dart';
import './UpdateClients.dart';

class ClientsScreen extends StatelessWidget {
  int? id = 0;

  ClientsScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final ClientsState c = Get.put(ClientsState());
    return Scaffold(
      appBar: AppBar(
          ...
          children: [
            AggridScreen(
              ...
              fields: [
                {
                  ...
                  'render': (data) => DataCell(ButtonWidget(
                        ...
                        text: 'Edit',
                        onTapCallBack: () {
                          Services.ShowModal(UpdateClientsScreen(data: data),
              ...
              newElementInitCallback: () {
                Services.ShowModal(CreateClientsScreen(),
                    barrierDismissible: false);
              },
              table: 'clients',
...
class ClientsState extends GetxController {
  var isLoading = false.obs;
  var gridApi = null.obs;
  var count = 0.obs;
  var formId = "clients".obs;
  var formData = {}.obs;
  var formState = "".obs;
  var formWidth = 'lg'.obs;
  var formKey = 0.obs;
  var tableKey = 0.obs;
  var url = 'http://127.0.0.1:8000/api/clients-Aggrid'.obs;
  var table = 'clients'.obs;
  var requette = 0.obs;
