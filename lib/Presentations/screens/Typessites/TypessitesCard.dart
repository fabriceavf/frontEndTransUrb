...
class TypessitesCardScreen extends StatelessWidget {
int? id = 0;
Map data;
        TypessitesCardScreen({Key? key,required this.data}) {
            try {
            ...
            final TypessitesCardState state = Get.put(TypessitesCardState());
        return BlocsWidget(
        child:Column(children: <Widget>[
            ...
            children: <Widget>[
                ...
                class TypessitesCardState extends GetxController {
                var errors= [].obs;
                ...
                var data=getForm();
                DioInstance.post('/api/typessites', data).then((response) {
