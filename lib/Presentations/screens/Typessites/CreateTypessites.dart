...
class CreateTypessitesScreen extends StatelessWidget {
int? id = 0;

CreateTypessitesScreen({Key? key }){
    try {
...
final CreateTypessitesState state = Get.put(CreateTypessitesState());
...
body:
    ...
    child: Text('Creer un Typessites',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateTypessitesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('typessites').add(data);
