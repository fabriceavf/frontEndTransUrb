...
class CreateSitesScreen extends StatelessWidget {
  int? id = 0;

  CreateSitesScreen({Key? key}) {
    try {
  ...
  Widget build(BuildContext context) {
    final CreateSitesState state = Get.put(CreateSitesState());
...
class CreateSitesState extends GetxController {
  var errors = [].obs;
