...
Map data;
    List<dynamic> directionsData=[];
                ServicesCardScreen({Key? key,required this.data}) {
            try {
            ...
            final ServicesCardState state = Get.put(ServicesCardState());
        return BlocsWidget(
        child:Column(children: <Widget>[
            ...
            children: <Widget>[
                ...
                class ServicesCardState extends GetxController {
                var errors= [].obs;
                ...
                var data=getForm();
                DioInstance.post('/api/services', data).then((response) {
