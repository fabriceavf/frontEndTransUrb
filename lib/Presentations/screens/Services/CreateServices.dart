...
final CreateServicesState state = Get.put(CreateServicesState());
...
body:
    ...
    child: Text('Creer un Services',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateServicesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('services').add(data);
