...
class HorairestypespostesCardScreen extends StatelessWidget {
int? id = 0;
Map data;
    List<dynamic> typespostesData=[];
                HorairestypespostesCardScreen({Key? key,required this.data}) {
            try {
            ...
            final HorairestypespostesCardState state = Get.put(HorairestypespostesCardState());
        return BlocsWidget(
        child:Column(children: <Widget>[
            ...
            children: <Widget>[
                ...
                class HorairestypespostesCardState extends GetxController {
                var errors= [].obs;
                ...
                var data=getForm();
                DioInstance.post('/api/horairestypespostes', data).then((response) {
