...
class UpdateTransactionsdetailsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateTransactionsdetailsScreen({Key? key ,required this.data}){
try {
...
final UpdateTransactionsdetailsState state = Get.put(UpdateTransactionsdetailsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Transactionsdetails',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateTransactionsdetailsState extends GetxController {
    var errors= [].obs;
    ...
    await db.table('transactionsdetails').where('id','=',id).update(data);
