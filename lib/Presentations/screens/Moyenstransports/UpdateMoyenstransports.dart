...
class UpdateMoyenstransportsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateMoyenstransportsScreen({Key? key ,required this.data}){
try {
...
final UpdateMoyenstransportsState state = Get.put(UpdateMoyenstransportsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Moyenstransports',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateMoyenstransportsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['typesmoyenstransport_id']?.text=data['typesmoyenstransport_id'].toString();
    ...
    await db.table('moyenstransports').where('id','=',id).update(data);
