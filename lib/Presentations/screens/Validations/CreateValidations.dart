...
class CreateValidationsScreen extends StatelessWidget {
int? id = 0;

CreateValidationsScreen({Key? key }){
    try {
...
final CreateValidationsState state = Get.put(CreateValidationsState());
...
body:
    ...
    child: Text('Creer un Validations',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateValidationsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('validations').add(data);
