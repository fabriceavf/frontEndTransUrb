...
class UpdateValidationsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateValidationsScreen({Key? key ,required this.data}){
try {
...
final UpdateValidationsState state = Get.put(UpdateValidationsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Validations',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
            ...
            Obx(()=>MyInputWidget(controller: state.inputControllers['nmbvalideurs'],label: "nmbvalideurs",placeHolder: "",valid:0)),
    ...
    class UpdateValidationsState extends GetxController {
    var errors= [].obs;
    var isLoading= false.obs;
        ...
        var inputControllers={
            ...
            'nmbvalideurs':TextEditingController(),
        }.obs;
    ...
    void setData(data){
            ...
            this.inputControllers['users']?.text=data['users'].toString();
            this.inputControllers['modelslisting_id']?.text=data['modelslisting_id'].toString();
            ...
            this.inputControllers['nmbvalideurs']?.text=data['nmbvalideurs'].toString();
        }
    ...
    await db.table('validations').where('id','=',id).update(data);
    var allValidations=await db.table('validations').get();
    print('allValidations');
    print(allValidations);
    ...
    void resetForm () {
            ...
            this.inputControllers['nmbvalideurs']?.text="";
    ...
    Map<String ,dynamic> getForm () {
        return {
                    ...
                    'nmbvalideurs' : this.inputControllers['nmbvalideurs']?.text,
                };
