...
class UpdateOauth_personal_access_clientsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateOauth_personal_access_clientsScreen({Key? key ,required this.data}){
try {
...
final UpdateOauth_personal_access_clientsState state = Get.put(UpdateOauth_personal_access_clientsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Oauth_personal_access_clients',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateOauth_personal_access_clientsState extends GetxController {
    var errors= [].obs;
    ...
    await db.table('oauth_personal_access_clients').where('id','=',id).update(data);
