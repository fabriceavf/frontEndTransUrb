...
class ActionsrealisesCardScreen extends StatelessWidget {
int? id = 0;
Map data;
    List<dynamic> actionsprevisionellesData=[];
                ActionsrealisesCardScreen({Key? key,required this.data}) {
            try {
            ...
            final ActionsrealisesCardState state = Get.put(ActionsrealisesCardState());
        return BlocsWidget(
        child:Column(children: <Widget>[
            ...
            children: <Widget>[
                ...
                class ActionsrealisesCardState extends GetxController {
                var errors= [].obs;
                ...
                var data=getForm();
                DioInstance.post('/api/actionsrealises', data).then((response) {
                ...
                void resetForm () {
                                    ...
                                    formFin_reel.value="";
                                    formActionsprevisionelle_id.value="";
                                    formCreat_by.value="";
                ...
                return {
                                    ...
                                    'actionsprevisionelle_id' : formActionsprevisionelle_id.value,
