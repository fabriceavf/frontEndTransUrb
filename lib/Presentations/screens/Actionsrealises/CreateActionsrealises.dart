...
class CreateActionsrealisesScreen extends StatelessWidget {
int? id = 0;

CreateActionsrealisesScreen({Key? key }){
    try {
...
final CreateActionsrealisesState state = Get.put(CreateActionsrealisesState());
...
body:
    ...
    child: Text('Creer un Actionsrealises',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateActionsrealisesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('actionsrealises').add(data);
