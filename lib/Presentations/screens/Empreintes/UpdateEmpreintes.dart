...
class UpdateEmpreintesScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateEmpreintesScreen({Key? key ,required this.data}){
try {
...
final UpdateEmpreintesState state = Get.put(UpdateEmpreintesState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Empreintes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
            
            
            Obx(()=>MyInputWidget(controller: state.inputControllers['signature'],label: "signature",placeHolder: "",valid:0)),
    ...
    class UpdateEmpreintesState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['signature']?.text=data['signature'].toString();
    ...
    await db.table('empreintes').where('id','=',id).update(data);
    var allEmpreintes=await db.table('empreintes').get();
    print('allEmpreintes');
    print(allEmpreintes);
    ...
    void resetForm () {
            ...
            this.inputControllers['signature']?.text="";
    ...
    Map<String ,dynamic> getForm () {
        return {
                    ...
                    'signature' : this.inputControllers['signature']?.text,
