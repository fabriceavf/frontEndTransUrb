...
class CreateInterventiondetailsScreen extends StatelessWidget {
int? id = 0;

CreateInterventiondetailsScreen({Key? key }){
    try {
...
final CreateInterventiondetailsState state = Get.put(CreateInterventiondetailsState());
...
body:
    ...
    child: Text('Creer un Interventiondetails',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateInterventiondetailsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('interventiondetails').add(data);
