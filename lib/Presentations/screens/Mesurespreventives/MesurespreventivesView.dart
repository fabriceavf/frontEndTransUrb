...
import './MesurespreventivesCard.dart';
import './CreateMesurespreventives.dart';
import './UpdateMesurespreventives.dart';

class MesurespreventivesScreen extends StatelessWidget {
int? id = 0;
MesurespreventivesScreen({Key? key}) {
try {
...
final MesurespreventivesState c = Get.put(MesurespreventivesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateMesurespreventivesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateMesurespreventivesScreen(),barrierDismissible: false);},
...
class MesurespreventivesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="mesurespreventives".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/mesurespreventives-Aggrid'.obs;
var table= 'mesurespreventives'.obs;
var requette= 0.obs;
