...
import './AgentsrapportsCard.dart';
import './CreateAgentsrapports.dart';
import './UpdateAgentsrapports.dart';

class AgentsrapportsScreen extends StatelessWidget {
int? id = 0;
AgentsrapportsScreen({Key? key}) {
try {
...
final AgentsrapportsState c = Get.put(AgentsrapportsState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateAgentsrapportsScreen(data:data),barrierDismissible: false);},
)
),
...
{
'libelle':'jour_abscences',
'render':(data)=>DataCell(Text(data['jour_abscences'].toString())),

},
{
'libelle':'jour_presences',
'render':(data)=>DataCell(Text(data['jour_presences'].toString())),
...
class AgentsrapportsState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="agentsrapports".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/agentsrapports-Aggrid'.obs;
var table= 'agentsrapports'.obs;
        var usersData=[].obs;
var requette= 1.obs;
