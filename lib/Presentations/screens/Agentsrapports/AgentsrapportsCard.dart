...
class AgentsrapportsCardScreen extends StatelessWidget {
int? id = 0;
Map data;
    List<dynamic> usersData=[];
                AgentsrapportsCardScreen({Key? key,required this.data}) {
            try {
            ...
            final AgentsrapportsCardState state = Get.put(AgentsrapportsCardState());
        return BlocsWidget(
        child:Column(children: <Widget>[
            ...
            children: <Widget>[
                ...
                Text(state.convertToString(data["Selectlabel"])),
                        ...
                        // Text(state.convertToString(data["jour_abscences"])),
                        // SizedBox(height: 2),

                    
                                    

                        // Text(state.convertToString(data["jour_presences"])),
                        // SizedBox(height: 2),
                ...
                class AgentsrapportsCardState extends GetxController {
                var errors= [].obs;
                ...
                var data=getForm();
                DioInstance.post('/api/agentsrapports', data).then((response) {
                ...
                void resetForm () {
                                    ...
                                    formMois.value="";
                                    formUser_id.value="";
                                    formJour_abscences.value="";
                                    formJour_presences.value="";
                                    formDay_01.value="";
                                    formDay_02.value="";
                                    formDay_03.value="";
                                    formDay_04.value="";
                ...
                return {
                                    ...
                                    'jour_abscences' : formJour_abscences.value,
                                    'jour_presences' : formJour_presences.value,
