...
import './HistoriquesCard.dart';
import './CreateHistoriques.dart';
import './UpdateHistoriques.dart';

class HistoriquesScreen extends StatelessWidget {
int? id = 0;
HistoriquesScreen({Key? key}) {
try {
...
final HistoriquesState c = Get.put(HistoriquesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateHistoriquesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateHistoriquesScreen(),barrierDismissible: false);},
table:'historiques',
...
class HistoriquesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="historiques".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/historiques-Aggrid'.obs;
var table= 'historiques'.obs;
var requette= 0.obs;
