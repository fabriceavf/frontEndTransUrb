...
import './ExtrasdatasCard.dart';
import './CreateExtrasdatas.dart';
import './UpdateExtrasdatas.dart';

class ExtrasdatasScreen extends StatelessWidget {
int? id = 0;
ExtrasdatasScreen({Key? key}) {
try {
...
final ExtrasdatasState c = Get.put(ExtrasdatasState());
return Scaffold(
appBar: AppBar(
backgroundColor: Theme.of(context).colorScheme.inversePrimary,
title: Text(' Extrasdatas '),
),
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateExtrasdatasScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateExtrasdatasScreen(),barrierDismissible: false);},
table:'extrasdatas',
...
class ExtrasdatasState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="extrasdatas".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/extrasdatas-Aggrid'.obs;
var table= 'extrasdatas'.obs;
var requette= 0.obs;
