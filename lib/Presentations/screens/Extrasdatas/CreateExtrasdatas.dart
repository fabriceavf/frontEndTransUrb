...
class CreateExtrasdatasScreen extends StatelessWidget {
int? id = 0;

CreateExtrasdatasScreen({Key? key }){
    try {
...
final CreateExtrasdatasState state = Get.put(CreateExtrasdatasState());
...
body:
    ...
    child: Text('Creer un Extrasdatas',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateExtrasdatasState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('extrasdatas').add(data);
