...
class CreateLignesScreen extends StatelessWidget {
int? id = 0;

CreateLignesScreen({Key? key }){
    try {
...
final CreateLignesState state = Get.put(CreateLignesState());
...
body:
    ...
    child: Text('Creer un Lignes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
                                    ...
                                    Obx(()=>MyInputWidget(controller: state.inputControllers['tarifs'],label: "tarifs",placeHolder: "",valid:0)),
...
class CreateLignesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('lignes').add(data);
