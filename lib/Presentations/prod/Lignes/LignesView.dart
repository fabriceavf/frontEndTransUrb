...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateLignesScreen(data:data),barrierDismissible: false);},
)
),
...
{
'libelle':'tarifs',
'render':(data)=>DataCell(Text(data['tarifs'].toString())),
...
'render':(data)=>DataCell(Text(data['updated_at'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateLignesScreen(),barrierDismissible: false);},
table:'lignes',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['ville_id'].toString())),DataCell(Text(data['code'].toString())),DataCell(Text(data['libelle'].toString())),DataCell(Text(data['tarifs'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['creat_by'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),],
    ),),],),
),
