...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateFormsScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['identifiants_sadge'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateFormsScreen(),barrierDismissible: false);},
table:'forms',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['libelle'].toString())),DataCell(Text(data['description'].toString())),DataCell(Text(data['childs'].toString())),DataCell(Text(data['champs'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['creat_by'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),],
    ),),],),
),
