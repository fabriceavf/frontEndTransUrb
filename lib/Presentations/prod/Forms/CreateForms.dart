...
class CreateFormsScreen extends StatelessWidget {
int? id = 0;

CreateFormsScreen({Key? key }){
    try {
...
final CreateFormsState state = Get.put(CreateFormsState());
...
body:
    ...
    child: Text('Creer un Forms',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
                                    ...
                                    Obx(()=>MyInputWidget(controller: state.inputControllers['childs'],label: "childs",placeHolder: "",valid:0)),

                                    
                                                                    
                                    Obx(()=>MyInputWidget(controller: state.inputControllers['champs'],label: "champs",placeHolder: "",valid:0)),
...
class CreateFormsState extends GetxController {
var errors= [].obs;
