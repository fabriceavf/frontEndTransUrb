...
import './GraphiquesCard.dart';
import './CreateGraphiques.dart';
import './UpdateGraphiques.dart';

class GraphiquesScreen extends StatelessWidget {
int? id = 0;
GraphiquesScreen({Key? key}) {
try {
...
final GraphiquesState c = Get.put(GraphiquesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateGraphiquesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['identifiants_sadge'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateGraphiquesScreen(),barrierDismissible: false);},
table:'graphiques',
...
class GraphiquesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="graphiques".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/graphiques-Aggrid'.obs;
var table= 'graphiques'.obs;
var requette= 0.obs;
