...
class CreateGraphiquesScreen extends StatelessWidget {
int? id = 0;

CreateGraphiquesScreen({Key? key }){
    try {
...
final CreateGraphiquesState state = Get.put(CreateGraphiquesState());
...
body:
    ...
    child: Text('Creer un Graphiques',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateGraphiquesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('graphiques').add(data);
