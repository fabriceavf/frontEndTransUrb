...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateCartesScreen(data:data),barrierDismissible: false);},
)
),
...
{
'libelle':'uid_mifare',
'render':(data)=>DataCell(Text(data['uid_mifare'].toString())),
...
'render':(data)=>DataCell(Text(data['updated_at'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateCartesScreen(),barrierDismissible: false);},
table:'cartes',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['code'].toString())),DataCell(Text(data['uid_mifare'].toString())),DataCell(Text(data['solde'].toString())),DataCell(Text(data['site_id'].toString())),DataCell(Text(data['etats'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['creat_by'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),],
    ),),],),
),
