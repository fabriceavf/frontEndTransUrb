...
children: <Widget>[
    ...
    child: Text('Update un Cartes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
            ...
            Obx(()=>MyInputWidget(controller: state.inputControllers['uid_mifare'],label: "uid_mifare",placeHolder: "",valid:0)),

        
            
            Obx(()=>MyInputWidget(controller: state.inputControllers['solde'],label: "solde",placeHolder: "",valid:0)),
