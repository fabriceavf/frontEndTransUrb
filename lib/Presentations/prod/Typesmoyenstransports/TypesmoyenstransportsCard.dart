...
class TypesmoyenstransportsCardScreen extends StatelessWidget {
int? id = 0;
Map data;
        TypesmoyenstransportsCardScreen({Key? key,required this.data}) {
            try {
            ...
            final TypesmoyenstransportsCardState state = Get.put(TypesmoyenstransportsCardState());
        return BlocsWidget(
        child:Column(children: <Widget>[
            ...
            children: <Widget>[
                ...
                class TypesmoyenstransportsCardState extends GetxController {
                var errors= [].obs;
                ...
                var data=getForm();
                DioInstance.post('/api/typesmoyenstransports', data).then((response) {
