...
class CreateTypesmoyenstransportsScreen extends StatelessWidget {
int? id = 0;

CreateTypesmoyenstransportsScreen({Key? key }){
    try {
...
final CreateTypesmoyenstransportsState state = Get.put(CreateTypesmoyenstransportsState());
...
body:
    ...
    child: Text('Creer un Typesmoyenstransports',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateTypesmoyenstransportsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('typesmoyenstransports').add(data);
