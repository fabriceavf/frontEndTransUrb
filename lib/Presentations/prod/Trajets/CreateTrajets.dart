...
class CreateTrajetsScreen extends StatelessWidget {
int? id = 0;

CreateTrajetsScreen({Key? key }){
    try {
...
final CreateTrajetsState state = Get.put(CreateTrajetsState());
...
body:
    ...
    child: Text('Creer un Trajets',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateTrajetsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('trajets').add(data);
