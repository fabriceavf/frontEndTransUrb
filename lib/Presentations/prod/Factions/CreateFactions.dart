...
class CreateFactionsScreen extends StatelessWidget {
int? id = 0;

CreateFactionsScreen({Key? key }){
    try {
...
final CreateFactionsState state = Get.put(CreateFactionsState());
...
body:
    ...
    child: Text('Creer un Factions',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateFactionsState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('factions').add(data);
