...
import './TypespointagesCard.dart';
import './CreateTypespointages.dart';
import './UpdateTypespointages.dart';

class TypespointagesScreen extends StatelessWidget {
int? id = 0;
TypespointagesScreen({Key? key}) {
try {
...
final TypespointagesState c = Get.put(TypespointagesState());
return Scaffold(
appBar: AppBar(
backgroundColor: Theme.of(context).colorScheme.inversePrimary,
title: Text(' Typespointages '),
),
drawer: DrawerAdmin(),
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateTypespointagesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['deleted_at'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateTypespointagesScreen(),barrierDismissible: false);},
...
class TypespointagesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="typespointages".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/typespointages-Aggrid'.obs;
var table= 'typespointages'.obs;
var requette= 0.obs;
