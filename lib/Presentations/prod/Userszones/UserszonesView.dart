...
import './UserszonesCard.dart';
import './CreateUserszones.dart';
import './UpdateUserszones.dart';

class UserszonesScreen extends StatelessWidget {
int? id = 0;
UserszonesScreen({Key? key}) {
try {
...
final UserszonesState c = Get.put(UserszonesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateUserszonesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateUserszonesScreen(),barrierDismissible: false);},
table:'userszones',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['user_id'].toString())),DataCell(Text(data['zone_id'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['creat_by'].toString())),],
    ),),],),
),
...
class UserszonesState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="userszones".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/userszones-Aggrid'.obs;
var table= 'userszones'.obs;
        var usersData=[].obs;
        var zonesData=[].obs;
var requette= 2.obs;
