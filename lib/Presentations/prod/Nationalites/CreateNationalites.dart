...
class CreateNationalitesScreen extends StatelessWidget {
int? id = 0;

CreateNationalitesScreen({Key? key }){
    try {
...
final CreateNationalitesState state = Get.put(CreateNationalitesState());
...
body:
    ...
    child: Text('Creer un Nationalites',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateNationalitesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('nationalites').add(data);
