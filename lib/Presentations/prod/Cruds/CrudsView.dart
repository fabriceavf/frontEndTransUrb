...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateCrudsScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateCrudsScreen(),barrierDismissible: false);},
table:'cruds',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['action'].toString())),DataCell(Text(data['entite'].toString())),DataCell(Text(data['entite_cle'].toString())),DataCell(Text(data['ancien'].toString())),DataCell(Text(data['nouveau'].toString())),DataCell(Text(data['user_id'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['Detail'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['creat_by'].toString())),],
    ),),],),
),
