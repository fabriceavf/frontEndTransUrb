...
class CreateSexesScreen extends StatelessWidget {
int? id = 0;

CreateSexesScreen({Key? key }){
    try {
...
final CreateSexesState state = Get.put(CreateSexesState());
...
body:
    ...
    child: Text('Creer un Sexes',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateSexesState extends GetxController {
var errors= [].obs;
