...
class UpdateListingsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateListingsScreen({Key? key ,required this.data}){
try {
...
final UpdateListingsState state = Get.put(UpdateListingsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Listings',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateListingsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['id_user']?.text=data['id_user'].toString();
            ...
            this.inputControllers['id_date']?.text=data['id_date'].toString();
    ...
    await db.table('listings').where('id','=',id).update(data);
