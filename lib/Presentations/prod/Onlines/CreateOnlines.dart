...
class CreateOnlinesScreen extends StatelessWidget {
int? id = 0;

CreateOnlinesScreen({Key? key }){
    try {
...
final CreateOnlinesState state = Get.put(CreateOnlinesState());
...
body:
    ...
    child: Text('Creer un Onlines',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateOnlinesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('onlines').add(data);
