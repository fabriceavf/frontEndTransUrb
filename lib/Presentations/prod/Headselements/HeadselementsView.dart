...
import './HeadselementsCard.dart';
import './CreateHeadselements.dart';
import './UpdateHeadselements.dart';

class HeadselementsScreen extends StatelessWidget {
int? id = 0;
HeadselementsScreen({Key? key}) {
try {
...
final HeadselementsState c = Get.put(HeadselementsState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateHeadselementsScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['deleted_at'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateHeadselementsScreen(),barrierDismissible: false);},
table:'headselements',
...
class HeadselementsState extends GetxController {
var isLoading = false.obs;
var gridApi = null.obs;
var count = 0.obs;
var formId="headselements".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/headselements-Aggrid'.obs;
var table= 'headselements'.obs;
