...
class CreateHorairesScreen extends StatelessWidget {
int? id = 0;

CreateHorairesScreen({Key? key }){
    try {
...
final CreateHorairesState state = Get.put(CreateHorairesState());
...
body:
    ...
    child: Text('Creer un Horaires',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateHorairesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('horaires').add(data);
