...
final CategoriesState c = Get.put(CategoriesState());
return Scaffold(
appBar: AppBar(
...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateCategoriesScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateCategoriesScreen(),barrierDismissible: false);},
table:'categories',
...
var count = 0.obs;
var formId="categories".obs;
var formData={}.obs;
var formState="".obs;
var formWidth='lg'.obs;
var formKey=0.obs;
var tableKey=0.obs;
var url= 'http://127.0.0.1:8000/api/categories-Aggrid'.obs;
var table= 'categories'.obs;
var requette= 0.obs;
