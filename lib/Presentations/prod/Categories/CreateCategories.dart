...
CreateCategoriesScreen({Key? key }){
    try {
...
final CreateCategoriesState state = Get.put(CreateCategoriesState());
...
body:
    ...
    child: Text('Creer un Categories',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
...
class CreateCategoriesState extends GetxController {
var errors= [].obs;
...
void createLine () async{
    ...
    await db.table('categories').add(data);
