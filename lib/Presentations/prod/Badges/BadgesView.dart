...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdateBadgesScreen(data:data),barrierDismissible: false);},
)
),
...
{
'libelle':'content',
'render':(data)=>DataCell(Text(data['content'].toString())),
...
'render':(data)=>DataCell(Text(data['node_version'].toString())),
...
'render':(data)=>DataCell(Text(data['creat_by'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreateBadgesScreen(),barrierDismissible: false);},
table:'badges',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['client_id'].toString())),DataCell(Text(data['content'].toString())),DataCell(Text(data['created_at'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['js'].toString())),DataCell(Text(data['libelle'].toString())),DataCell(Text(data['css'].toString())),DataCell(Text(data['node_version'].toString())),DataCell(Text(data['extra_attributes'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['identifiants_sadge'].toString())),DataCell(Text(data['creat_by'].toString())),],
    ),),],),
),
