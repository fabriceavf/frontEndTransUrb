...
children: <Widget>[
    ...
    child: Text('Update un Badges',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
            
            
            
            Obx(()=>MyInputWidget(controller: state.inputControllers['content'],label: "content",placeHolder: "",valid:0)),

        
            
            
            
            Obx(()=>MyInputWidget(controller: state.inputControllers['js'],label: "js",placeHolder: "",valid:0)),
            ...
            Obx(()=>MyInputWidget(controller: state.inputControllers['css'],label: "css",placeHolder: "",valid:0)),

        
            
            Obx(()=>MyInputWidget(controller: state.inputControllers['node_version'],label: "node_version",placeHolder: "",valid:0)),
    ...
    void setData(data){
            ...
            this.inputControllers['node_version']?.text=data['node_version'].toString();
