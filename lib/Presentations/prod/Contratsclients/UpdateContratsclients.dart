...
class UpdateContratsclientsScreen extends StatelessWidget {
int? id = 0;
Map data;
UpdateContratsclientsScreen({Key? key ,required this.data}){
try {
...
final UpdateContratsclientsState state = Get.put(UpdateContratsclientsState());
state.setData(data);
...
children: <Widget>[
    ...
    child: Text('Update un Contratsclients',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
    ...
    class UpdateContratsclientsState extends GetxController {
    var errors= [].obs;
    ...
    void setData(data){
            ...
            this.inputControllers['AllSites']?.text=data['AllSites'].toString();
    ...
    await db.table('contratsclients').where('id','=',id).update(data);
