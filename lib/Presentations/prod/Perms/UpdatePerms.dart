...
children: <Widget>[
    ...
    child: Text('Update un Perms',style: TextStyle(fontSize: Constants.size['large']['fontSize'].toDouble()),),
    ),
            
            
            Obx(()=>MyInputWidget(controller: state.inputControllers['permission_label'],label: "permission_label",placeHolder: "",valid:0)),

        
            
            Obx(()=>MyInputWidget(controller: state.inputControllers['permission_nom'],label: "permission_nom",placeHolder: "",valid:0)),
    ...
    void setData(data){
            ...
            this.inputControllers['permission_label']?.text=data['permission_label'].toString();
            this.inputControllers['permission_nom']?.text=data['permission_nom'].toString();
