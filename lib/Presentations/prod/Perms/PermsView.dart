...
text: 'Edit',
onTapCallBack: (){Services.ShowModal(UpdatePermsScreen(data:data),barrierDismissible: false);},
)
),
...
'render':(data)=>DataCell(Text(data['permission_label'].toString())),

},
{
'libelle':'permission_nom',
'render':(data)=>DataCell(Text(data['permission_nom'].toString())),
...
'render':(data)=>DataCell(Text(data['created_at'].toString())),
    ...
    newElementInitCallback: (){Services.ShowModal(CreatePermsScreen(),barrierDismissible: false);},
table:'perms',
showWidgetCallback:  (data) =>DataRow(cells: <DataCell>[DataCell(Text(data['id'].toString())),DataCell(Text(data['permission_label'].toString())),DataCell(Text(data['permission_nom'].toString())),DataCell(Text(data['permission_id'].toString())),DataCell(Text(data['updated_at'].toString())),DataCell(Text(data['user_id'].toString())),DataCell(Text(data['nom'].toString())),DataCell(Text(data['prenom'].toString())),DataCell(Text(data['type'].toString())),DataCell(Text(data['deleted_at'].toString())),DataCell(Text(data['created_at'].toString())),],
    ),),],),
),
